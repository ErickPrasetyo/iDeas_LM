object KasirNonTunaiFrm: TKasirNonTunaiFrm
  Left = 205
  Top = 70
  Width = 961
  Height = 659
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini berisi daftar transaksi Kasir Tunai ,  Bila tidak berka' +
        'itan dengan hutang kosongi saja no reff-nya.'
      Color = clWhite
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'debet'
              Column = grddbtvMasterdebet
            end
            item
              Format = '0.0,0'
              Kind = skSum
              FieldName = 'kredit'
              Column = grddbtvMasterkredit
            end>
          ...
          object grddbtvMasterno_payment: TcxGridDBColumn
            Caption = 'No. Kasir Tunai'
            DataBinding.FieldName = 'no_kas_kecil'
          ...
          object grddbtvMasterdt_payment: TcxGridDBColumn
            Caption = 'Tanggal'
            DataBinding.FieldName = 'dt_kas_kecil'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 82
          end
          ...
          object grddbtvMasterno_cek_bg_tt: TcxGridDBColumn
            Caption = 'No. Cek/BG/TT'
            DataBinding.FieldName = 'no_cek_bg_tt'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 97
          end
          object grddbtvMasterdt_biaya: TcxGridDBColumn
            Caption = 'Tgl. Jth Tempo'
            DataBinding.FieldName = 'dt_biaya'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 129
          end
          object grddbtvMasterbank: TcxGridDBColumn
            Caption = 'Bank'
          ...
          object grddbtvMasterkredit: TcxGridDBColumn
            Caption = 'Kredit'
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object edtDateEdit: TcxDBDateEdit
          Left = 102
          Top = 77
          DataBinding.DataField = 'dt_kas_kecil'
          DataBinding.DataSource = dsMaster
          Properties.OnChange = edtDateEditPropertiesChange
          Style.Edges = []
          Style.Shadow = False
          TabOrder = 2
        ...
        object edtId_SO: TcxDBTextEdit
          Left = 103
          Top = 28
          DataBinding.DataField = 'no_kas_kecil'
          DataBinding.DataSource = dsMaster
        ...
        object cxGroupBox3: TcxGroupBox
          Left = 250
          Top = 20
          Caption = 'Terima Dari/Dibayarkan Kepada'
          TabOrder = 4
          Transparent = True
          Height = 102
          Width = 285
          ...
          object edtAtasNama: TcxDBTextEdit
            Left = 69
            Top = 66
            DataBinding.DataField = 'atas_nama'
            DataBinding.DataSource = dsMaster
            ParentFont = False
            Style.Font.Charset = ANSI_CHARSET
            Style.Font.Color = clWindowText
        ...
        object edtIdxNo: TcxDBTextEdit
          Left = 102
          Top = 52
          DataBinding.DataField = 'id_kas_kecil'
          DataBinding.DataSource = dsMaster
          ParentFont = False
      ...
      object grdDetail: TcxGrid
        ...
        object grdDetailDBBTV: TcxGridDBBandedTableView
          ...
          object grdDetailDBBTVkd_rekanan: TcxGridDBBandedColumn
            Caption = 'NO. OUTLET'
            DataBinding.FieldName = 'kd_rekanan'
            OnGetPropertiesForEdit = grdDetailDBBTVkd_rekananGetPropertiesForEdit
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Filtering = False
            Options.FilteringFilteredItemsList = False
          ...
          object grdDetailDBBTVno_cek_bg_tt: TcxGridDBBandedColumn
            Caption = 'No. Cek/BG/TT'
            DataBinding.FieldName = 'no_cek_bg_tt'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grdDetailDBBTVdt_biaya: TcxGridDBBandedColumn
            Caption = 'Jth Tempo'
            DataBinding.FieldName = 'dt_biaya'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grdDetailDBBTVbank: TcxGridDBBandedColumn
            Caption = 'BANK'
            DataBinding.FieldName = 'bank'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grdDetailDBBTVdebet: TcxGridDBBandedColumn
            Caption = 'DEBET'
            DataBinding.FieldName = 'debet'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grdDetailDBBTVkredit: TcxGridDBBandedColumn
            Caption = 'KREDIT'
            DataBinding.FieldName = 'kredit'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'select * '
      'from accfin.kas_kecil'
      'where id_kas_kecil=:id_kas_kecil')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id_kas_kecil'
    ...
    object Masterid_kas_kecil: TLargeintField
      FieldName = 'id_kas_kecil'
      Required = True
    end
    object Masterdt_kas_kecil: TDateTimeField
      FieldName = 'dt_kas_kecil'
      Required = True
    end
    object Masterno_kas_kecil: TStringField
    ...
    object Masteratas_nama: TStringField
      FieldName = 'atas_nama'
      Size = 100
    end
  ...
  object Detail: TZQuery
    ...
    SQL.Strings = (
      'select * from accfin.kas_kecil_detail'
      'where id_kas_kecil=:id_kas_kecil'
      'order by nomor')
    Params = <
      item
    ...
    object Detailid_kas_kecil: TLargeintField
      FieldName = 'id_kas_kecil'
      Required = True
    end
    ...
    object Detaildt_biaya: TDateTimeField
      FieldName = 'dt_biaya'
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object Detailisbukti: TStringField
      FieldName = 'isbukti'
      Required = True
      Size = 1
    end
    ...
    object Detailno_cek_bg_tt: TStringField
  ...
  object qryGet_KK_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select accfin.fn_gen_kas_kecil_number(:pid_trans,:ptgl) as kk_nu' +
        'mber')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qryGet_KK_Numberkk_number: TStringField
      FieldName = 'kk_number'
      ReadOnly = True
      Size = 255
    end
  ...
  object MemDetail: TkbmMemTable
    ...
    object MemDetaildebet: TFloatField
      FieldName = 'debet'
    end
    object MemDetailkredit: TFloatField
      FieldName = 'kredit'
    end
  end
  ...
  object qrySubTotal: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select sum(debet-kredit) as sub_total '
      'from accfin.kas_kecil_detail'
      'where id_kas_kecil=:pid_kas_kecil')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid_kas_kecil'
  ...
  object L_Nota: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'SELECT a.* '
      'FROM accfin .fn_gen_look_kasir_non_tunai(:pid) a')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid'
    ...
    object L_Notaid_division: TStringField
  ...
  object ER: TcxEditRepository
    ...
    object ER_LCB_CUSTOMER: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownAutoSize = True
      Properties.GridMode = True
  ...
  object qBrowse: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.id_kas_kecil, a.no_kas_kecil, a.dt_kas_kecil, a.id_rek_' +
        'gl, a.usr_upd, a.ispost, a.iscancel, a.atas_nama, kk.description' +
        's as nama_rekening,'
      
        #9'b.diskripsi, b.debet, b.kredit, b.no_cek_bg_tt, b.bank, b.dt_bi' +
        'aya'
      'FROM accfin.kas_kecil a'
      'JOIN accfin.kas_kecil_detail b ON b.id_kas_kecil=a.id_kas_kecil'
      'LEFT JOIN master.mrek_gl kk ON kk.id_rek_gl=a.id_rek_gl'
      'WHERE a.isdelete='#39'0'#39' and a.id_trans=:pid_trans'
      
        'and a.dt_kas_kecil between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and' +
    ...
    object qBrowseid_kas_kecil: TLargeintField
      FieldName = 'id_kas_kecil'
      Required = True
    end
    object qBrowseno_kas_kecil: TStringField
      FieldName = 'no_kas_kecil'
    end
    object qBrowsedt_kas_kecil: TDateTimeField
      FieldName = 'dt_kas_kecil'
      Required = True
      DisplayFormat = 'dd-mmm-yyyy'
    end
    ...
    object qBrowseno_cek_bg_tt: TStringField
      FieldName = 'no_cek_bg_tt'
      Size = 50
    end
    object qBrowsebank: TStringField
      FieldName = 'bank'
      Size = 50
    end
    object qBrowsedt_biaya: TDateTimeField
      FieldName = 'dt_biaya'
      DisplayFormat = 'dd-mmm-yyyy'
    end
  end
  object sq_Kasir_Detail: TZSequence
    Connection = DM.conn
    SequenceName = 'accfin.sq_kasir_detail'
    Left = 577
    Top = 8
  end
  ...
  object qryCek: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'from accfin.kas_kecil'
        ...
        'where id_trans=:pid_trans and isdelete='#39'0'#39' and no_kas_kecil=:pno' +
        'mor ')
    Params = <
      item
        DataType = ftUnknown
