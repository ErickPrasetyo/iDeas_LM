object InfoNewNeracaFrm: TInfoNewNeracaFrm
  Left = 182
  Top = 67
  Width = 1141
  Height = 682
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini adalah lapoan neraca perusahaan dengan perbandingan akh' +
        'ir periode sekarang dan periode tahun lalu'
      Color = clWhite
  ...
  object RzSplitter1: TRzSplitter
    ...
    object grdAKTIVA: TcxGrid
      ...
      ParentFont = False
      TabOrder = 0
      object grddbtv_AKTIVA: TcxGridDBTableView
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            Format = '0.0,0'
            Kind = skSum
            FieldName = 'periode_ini'
            Column = grddbtv_AKTIVAperiode_ini
          end
          item
            Format = '0.0,0'
            Kind = skSum
            FieldName = 'periode_lalu'
            Column = grddbtv_AKTIVAperiode_lalu
          end>
        ...
        object grddbtv_AKTIVAdiskripsi: TcxGridDBColumn
          Caption = 'DISKRIPSI'
        ...
        object grddbtv_AKTIVAperiode_lalu: TcxGridDBColumn
          Caption = 'PERIODE LALU'
          DataBinding.FieldName = 'periode_lalu'
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
          Options.Editing = False
          Options.Filtering = False
        ...
        object grddbtv_AKTIVAperiode_ini: TcxGridDBColumn
          Caption = 'PERIODE INI'
          DataBinding.FieldName = 'periode_ini'
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
          Options.Editing = False
          Options.Filtering = False
      ...
      object grdLvlAKTIVA: TcxGridLevel
        GridView = grddbtv_AKTIVA
      end
    end
    ...
    object grdPASIVA: TcxGrid
      ...
      ParentFont = False
      TabOrder = 0
      object grddbtv_PASIVA: TcxGridDBTableView
        NavigatorButtons.ConfirmDelete = False
        ...
        DataController.Summary.FooterSummaryItems = <
          item
            ...
            Kind = skSum
            FieldName = 'periode_ini'
            Column = grddbtv_PASIVAperiode_ini
          end
          item
            Format = '0.0,0'
            Kind = skSum
            FieldName = 'periode_lalu'
            Column = grddbtv_PASIVAperiode_lalu
          end>
        DataController.Summary.SummaryGroups = <>
        OptionsBehavior.GoToNextCellOnEnter = True
        OptionsData.CancelOnExit = False
        ...
        Styles.Header = cxStyle1
        Styles.Indicator = cxStyle4
        object grddbtv_PASIVAdiskripsi: TcxGridDBColumn
          Caption = 'DISKRIPSI'
          DataBinding.FieldName = 'diskripsi'
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object grddbtv_PASIVAperiode_lalu: TcxGridDBColumn
          Caption = 'PERIODE LALU'
          DataBinding.FieldName = 'periode_lalu'
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
        ...
        object grddbtv_PASIVAperiode_ini: TcxGridDBColumn
          Caption = 'PERIODE INI'
          DataBinding.FieldName = 'periode_ini'
          HeaderAlignmentHorz = taCenter
          HeaderAlignmentVert = vaCenter
  ...
  object qAktiva: TZQuery
    ...
    SQL.Strings = (
      'SELECT * '
      'FROM accfin.fn_get_neraca(:ptgl0, :ptgl1)'
      'WHERE SUBSTR(id_rek_neraca,1,1)='#39'1'#39)
    Params = <
      item
        DataType = ftString
        Name = 'ptgl0'
    ...
    object qAktivaid_rek_neraca: TStringField
      FieldName = 'id_rek_neraca'
      ReadOnly = True
      Size = 255
    end
    object qAktivadiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    object qAktivajenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object qAktivaperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
      DisplayFormat = '#,##0.00;#,##0.00'
    end
    object qAktivaperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
      DisplayFormat = '#,##0.00;#,##0.00'
    end
  ...
  object frxNERACA: TfrxReport
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 699.213050000000000000
        Condition = 'frxDBAktiva."jenis"'
        object Memo6: TfrxMemoView
          Top = 18.897650000000000000
          Width = 264.567002360000000000
          Height = 22.677180000000000000
          DataField = 'jenis'
          DataSet = frxDBAktiva
          DataSetName = 'frxDBAktiva'
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo14: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBAktiva."periode_ini">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBAktiva."periode_lalu">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object GroupFooter2: TfrxGroupFooter
        ...
        object Memo27: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBPasiva."periode_ini">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo28: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBPasiva."periode_lalu">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object qPasiva: TZQuery
    ...
    object qPasivaid_rek_neraca: TStringField
      FieldName = 'id_rek_neraca'
      ReadOnly = True
      Size = 255
    end
    object qPasivadiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    object qPasivajenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object qPasivaperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
      DisplayFormat = '#,##0.00;#,##0.00'
    end
    object qPasivaperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
      DisplayFormat = '#,##0.00;#,##0.00'
    end
  ...
  object qPrintAktiva: TZQuery
    ...
    object qPrintAktivaid_rek_neraca: TStringField
      FieldName = 'id_rek_neraca'
      ReadOnly = True
      Size = 255
    end
    object qPrintAktivadiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    object qPrintAktivajenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object qPrintAktivaperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
    end
    object qPrintAktivaperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
    end
  end
  object frxDBAktiva: TfrxDBDataset
    UserName = 'frxDBAktiva'
    CloseDataSource = False
    FieldAliases.Strings = (
  ...
  object frxDBPasiva: TfrxDBDataset
    UserName = 'frxDBPasiva'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_rek_neraca=id_rek_neraca'
      'diskripsi=diskripsi'
  ...
  object qPrintPasiva: TZQuery
    ...
    object qPrintPasivaid_rek_neraca: TStringField
      FieldName = 'id_rek_neraca'
      ReadOnly = True
      Size = 255
    end
    object qPrintPasivadiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    object qPrintPasivajenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object qPrintPasivaperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
    end
    object qPrintPasivaperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
    end
  end
