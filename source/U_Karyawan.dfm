object KaryawanFrm: TKaryawanFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 42
      AutoSize = False
      Caption = 'Form ini berisi daftar kayawan yang bekerja di Perusahaan.'
      Color = clWhite
    ...
    object tsBrowse: TcxTabSheet
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterid_dokter: TcxGridDBColumn
            Caption = 'ID'
          ...
          object grddbtvMasternama_dokter: TcxGridDBColumn
          ...
          object grddbtvMastergender: TcxGridDBColumn
            Caption = 'Gender'
          ...
          object grddbtvMasteraddress: TcxGridDBColumn
            Caption = 'Alamat'
          ...
          object grddbtvMastercell_phone: TcxGridDBColumn
            Caption = 'Hand Phone'
            DataBinding.FieldName = 'cell_phone'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 107
          ...
          object grddbtvMasterbagian: TcxGridDBColumn
            Caption = 'Bagian'
          ...
          object grddbtvMasterspesialisasi: TcxGridDBColumn
            Caption = 'Jabatan'
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlDetailSupplier: TRzPanel
        ...
        object edtTglLahir: TcxDBDateEdit
          Left = 223
          Top = 226
          DataBinding.DataField = 'dt_birth'
          DataBinding.DataSource = dsMaster
          TabOrder = 9
          Width = 173
        end
        object edtTglMasuk: TcxDBDateEdit
          Left = 222
          Top = 268
          DataBinding.DataField = 'join_date'
          DataBinding.DataSource = dsMaster
          TabOrder = 11
          Width = 173
        end
        object cbxKawin: TcxDBComboBox
          Left = 12
          Top = 268
          DataBinding.DataField = 'sts_kawin'
          DataBinding.DataSource = dsMaster
        ...
        object cbxJnsKel: TcxDBComboBox
          Left = 223
          Top = 96
        ...
        object edtAktif: TcxDBCheckBox
          Left = 271
          Top = 57
          Caption = 'Pegawai Aktif'
  ...
  object Master: TZQuery
    ...
    object Masterinitial: TStringField
      FieldName = 'initial'
      Size = 10
    end
    ...
    object Masterdepartment: TStringField
      FieldName = 'department'
      Size = 50
    end
    object Masterjabatan: TStringField
      FieldName = 'jabatan'
      Size = 100
    end
    ...
    object Masterjoin_date: TDateTimeField
      FieldName = 'join_date'
    end
    ...
    object Masterphone1: TStringField
      FieldName = 'phone1'
      Size = 50
    end
    object Mastercell_phone: TStringField
      FieldName = 'cell_phone'
      Size = 50
    end
    object Masterextention: TStringField
      FieldName = 'extention'
      Size = 5
    end
    ...
    object Mastergender: TStringField
      FieldName = 'gender'
    end
    object Masterbirth_place: TStringField
      FieldName = 'birth_place'
    end
    object Masterdt_birth: TDateTimeField
      FieldName = 'dt_birth'
    end
    object Mastersts_kawin: TStringField
      FieldName = 'sts_kawin'
      Size = 50
    end
  end
