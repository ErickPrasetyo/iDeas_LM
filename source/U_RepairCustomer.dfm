object RepairCustomerFrm: TRepairCustomerFrm
  Left = 301
  Top = 228
  Width = 588
  Height = 243
  BorderStyle = bsSizeToolWin
  Caption = 'Perbaikan Data Master Outlet'
  Color = clWindow
  Ctl3D = False
  ...
  object ADOConnection1: TADOConnection
    ConnectionString = 
      ...
      'wDeploy\iDeasULI\doc\TOKO.xls;Mode=ReadWrite;Persist Security In' +
      'fo=False;Jet OLEDB:System database="";Jet OLEDB:Registry Path=""' +
      ';Jet OLEDB:Database Password="";Jet OLEDB:Engine Type=35;Jet OLE' +
  ...
  object oqITEM: TZQuery
    ...
    Left = 203
    Top = 99
    object oqITEMkd_rekanan: TStringField
      FieldName = 'kd_rekanan'
      Required = True
    end
    object oqITEMnama_rekanan: TStringField
      FieldName = 'nama_rekanan'
      Required = True
      Size = 255
    end
    object oqITEMalamat: TStringField
      FieldName = 'alamat'
      Required = True
      Size = 255
    end
    ...
    object oqITEMdt_upd: TDateTimeField
      FieldName = 'dt_upd'
      Required = True
    end
    object oqITEMtelephone: TStringField
      FieldName = 'telephone'
      Size = 100
    end
    object oqITEMid_rekanan: TLargeintField
  ...
  object sdfdtstOutlet: TSdfDataSet
    FileMustExist = True
    ReadOnly = False
    FieldDefs = <>
    Delimiter = '|'
