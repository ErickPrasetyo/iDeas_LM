object BukuKasirFrm: TBukuKasirFrm
  Left = 85
  Top = 76
  Width = 1147
  Height = 636
  ...
  object SCPanel1: TSCPanel
    ...
    object edtSalAwal: TcxDBTextEdit
      Left = 953
      Top = 8
      DataBinding.DataField = 'awal'
      DataBinding.DataSource = dsRek
      Properties.Alignment.Horz = taRightJustify
      Properties.Alignment.Vert = taVCenter
      Properties.ReadOnly = True
      Style.BorderStyle = ebsFlat
      Style.Color = 16511984
  ...
  object pnlTop: TSCPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini berisi rekapitulasi transaksi kasir tunai dan non tunai' +
  ...
  object pnlFooter: TSCPanel
    ...
    object edtMutasi: TcxDBTextEdit
      Left = 980
      Top = 10
      DataBinding.DataField = 'mutasi'
      DataBinding.DataSource = dsRek
      Properties.Alignment.Horz = taRightJustify
      Properties.Alignment.Vert = taVCenter
      Properties.ReadOnly = True
      Style.BorderStyle = ebsFlat
      Style.Color = 15986925
      Style.TextColor = clRed
      TabOrder = 0
      Width = 146
    end
    object edtSalAkhir: TcxDBTextEdit
      Left = 980
      Top = 34
      DataBinding.DataField = 'akhir'
      DataBinding.DataSource = dsRek
      Properties.Alignment.Horz = taRightJustify
      Properties.Alignment.Vert = taVCenter
      Properties.ReadOnly = True
  ...
  object rsMaster: TRzSplitter
    ...
    object grdDetail: TcxGrid
      ...
      object grddbtvDetail: TcxGridDBTableView
        ...
        object grddbtvDetailatas_nama: TcxGridDBColumn
          Caption = 'Penyetor/Penerima'
        ...
        object grddbtvDetailno_cek_bg_tt: TcxGridDBColumn
        ...
        object grddbtvDetailbank: TcxGridDBColumn
          Caption = 'BANK'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'SELECT k.no_kas_kecil, k.dt_kas_kecil, k.atas_nama, k.usr_upd, '
      
        '       kd.dt_biaya, kd.no_reff, kd.diskripsi, kd.no_cek_bg_tt, k' +
        'd.bank, kd.debet, kd.kredit'
      'FROM accfin.kas_kecil k'
      
        'JOIN accfin.kas_kecil_detail kd ON kd.id_kas_kecil=k.id_kas_keci' +
        'l'
      
        'WHERE k.isdelete='#39'0'#39' and k.iscancel='#39'0'#39' AND k.id_rek_gl=:pid_rek' +
        '_gl'
      
        '      AND k.dt_kas_kecil between to_timestamp(:ptgl0,'#39'dd/mm/yyyy' +
        #39') and to_timestamp(:ptgl1,'#39'dd/mm/yyyy'#39') +  interval '#39'23 hours 5' +
        '9 min'#39';')
    Params = <
      item
        DataType = ftString
    ...
    object Masterdt_biaya: TDateTimeField
      FieldName = 'dt_biaya'
      ReadOnly = True
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object Masterno_reff: TStringField
      FieldName = 'no_reff'
      ReadOnly = True
      Size = 255
    end
  ...
  object dsRek: TDataSource
    DataSet = qryRek
    Left = 304
    Top = 12
  end
  object qryRek: TZQuery
    Connection = DM.conn
    BeforeOpen = qryRekBeforeOpen
    AfterScroll = qryRekAfterScroll
    OnCalcFields = qryRekCalcFields
    SQL.Strings = (
      'select a.*'
      'FROM accfin.fn_rep_saldo_buku_kasir(:ptgl0,:ptgl1) a')
    Params = <
      item
        DataType = ftString
        Name = 'ptgl0'
    ...
    object qryRekid_rek_gl: TStringField
      FieldName = 'id_rek_gl'
      ReadOnly = True
      Size = 255
    end
    object qryReknama_rekening: TStringField
      FieldName = 'nama_rekening'
      ReadOnly = True
      Size = 255
    end
    object qryRekawal: TFloatField
      FieldName = 'awal'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object qryRekmutasi: TFloatField
      FieldName = 'mutasi'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object qryRekakhir: TFloatField
