object NotaDebetFrm: TNotaDebetFrm
  Left = 187
  Top = 50
  Width = 1097
  Height = 639
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 20
      AutoSize = False
      Caption = 'Form ini berisi Nota Debet/Retur ke Supplier'
      Color = clWhite
  ...
  object qrySubTotal: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select sum((qty_karton*hrg_beli_karton)+((qty_biji/biji_per_kart' +
        'on)*hrg_beli_karton)) as sub_total '
  ...
  object qryITEM: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'a.hrg_beli, a.rasio, a.id_rek_persediaan'
      'from master.item a'
  ...
  object rptPOLokal: TfrxReport
    ...
    object Page1: TfrxReportPage
      ...
      TopMargin = 45.000000000000000000
      ...
      object Footer1: TfrxFooter
        ...
        object Memo23: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '1. Penyerahan Barang       :  [frxDBkmtMaster."delivery_date"]'
            
              '2. Pembayaran                  :  [frxDBkmtMaster."payment_terms' +
              '"]'
            '3. Barang tersebut mohon dikirm ke alamat : '
            '     [frxDBkmtMaster."delivery_place"]'
            ''
            
              '4. Dan mohon untuk pengiriman barang dilampiri :  [frxDBkmtMaste' +
              'r."remarks"]'
            ''
            '')
          ParentFont = False
  ...
  object qBrowse: TZQuery
    ...
    SQL.Strings = (
        ...
        'scancel, a.kd_rekanan, b.nama_rekanan, a.cara_bayar, a.dt_jth_te' +
        'mpo, '
      #9'a.vat_num, a.no_bukti, a.disc_rp, a.total'
      'FROM transaksi.nota a'
      'LEFT JOIN master.mrekanan b ON b.kd_rekanan=a.kd_rekanan'
  ...
  object frxPrintRetur: TfrxReport
    Version = '5.2.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbExport, pbZoom, pbPageSetup, pbNavigator]
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo55: TfrxMemoView
          ...
          Memo.UTF8 = (
            'Dengan hormat,'
            'Dengan ini kami mohon retur barang sebagai berikut :')
          ParentFont = False
        end
        object Memo8: TfrxMemoView
          Top = 22.897650000000000000
      ...
      object Footer1: TfrxFooter
        ...
        object Memo23: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '1. Barang tersebut mohon diretur ke [frxDBMaster."vendor_name"]'
            '2. Dan mohon untuk dilampiri bukti penerimaan barang')
          ParentFont = False
          Formats = <
            item
            end
        ...
        object MemoApprovedBy: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'Pamekasan, [frxDBMaster."dated"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo7: TfrxMemoView
          Left = 18.897650000000000000
          Top = 223.244280000000000000
          Width = 234.330860000000000000
          Height = 22.677180000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
