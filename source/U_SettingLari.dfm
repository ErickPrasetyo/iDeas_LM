object SettingLariFrm: TSettingLariFrm
  Left = 259
  Top = 137
  Width = 738
  Height = 546
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini digunakan untuk merancang bentuk laba-rugi berdasarkan ' +
        'pengelompokan kode rekening perkiraan. Sehingga nantinya bentuk ' +
        'laba-rugi sesuai dengan yang diinginkan'
      Color = clWhite
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMastervuser: TcxGridDBColumn
            Caption = 'Kode Neraca'
            DataBinding.FieldName = 'id_rek_rl'
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlDetailData: TPanel
        ...
        object edtUserName: TcxDBTextEdit
          Left = 111
          Top = 8
          DataBinding.DataField = 'id_rek_rl'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'select * from accfin.mrek_laba_rugi')
    Params = <>
    Left = 180
    Top = 10
