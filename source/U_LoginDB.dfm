object LoginDBfrm: TLoginDBfrm
  ...
  object lblHeaderComment: TLabel
    ...
    Width = 235
    Height = 16
    Caption = 'Set Database Server Connection'
    Color = clWhite
    Font.Charset = ANSI_CHARSET
    Font.Color = 15437112
    Font.Height = -13
  ...
  object lblDescription: TLabel
    ...
    Height = 16
    AutoSize = False
    Caption = 'Masukan informasi database server di bawah ini :'
    Color = clWhite
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -11
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Untuk melakukan koneksi ke database server, software membutuhkan' +
