object TalanganFrm: TTalanganFrm
  Left = 226
  Top = 4
  Width = 984
  Height = 700
    ...
    object tsBrowse: TcxTabSheet
      ...
      object grdMaster: TcxGrid
        ...
        object grdMasterDBTable: TcxGridDBTableView
          ...
          object grdMasterDBTablefull_name: TcxGridDBColumn
          ...
          object grdMasterDBTablenama_rekening: TcxGridDBColumn
            Caption = 'Rekening'
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 20
      AutoSize = False
      Caption = 'Form ini berisi Formulir Permohonan Dana Talangan'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object qBrowse: TZQuery
    ...
    SQL.Strings = (
        ...
        'select a.id_kasbon, a.nk, a.no_kasbon, a.dt_purposed, b.descript' +
        'ions as nama_rekening, a.remarks, a.ispost, a.iscancel, a.id_rek' +
        '_gl, a.jumlah,'
      #9'a.isclosed, a.status_auth, a.kasbon_untuk, c.full_name,'
      ...
      'left join master.mpegawai c ON c.nk=a.nk'
  ...
  object qryRek_GL: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'SELECT * FROM master.vmrek_gl_piutang_lain_uli'
      'ORDER BY id_rek_gl')
    Params = <>
    Left = 488
    Top = 3
