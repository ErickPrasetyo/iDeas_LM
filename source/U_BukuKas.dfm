object BukuKasFrm: TBukuKasFrm
  ...
  object pnlTop: TSCPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 35
      AutoSize = False
      Caption = 'Form ini mewakili Buku Kas'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object LookRek: TwwLookupDialog
    Selected.Strings = (
      'descriptions'#9'40'#9'DISKRIPSI'#9'F'
      'id_rek_gl'#9'25'#9'KODE REK.'#9'F')
    GridTitleAlignment = taCenter
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = qryRek
    Caption = 'Lookup Piutang'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
    Left = 273
