object KasMasukFrm: TKasMasukFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini mewakili daftar Bukti Kas Masuk Khusus untuk piutang ji' +
        'ka dipanggil no reff  tampil sejarah piutang tsb. Jumlah, yang t' +
        'elah dibayar(pembayaran) dan sisa. Bila tidak berkaitan dengan p' +
        'iutang kosongi saja no reff-nya.'
      Color = clWhite
  ...
  object qryGet_CR_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select accfin.fn_gen_payment_number(:pid_trans,:ptgl) as cr_numb' +
        'er')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qryGet_CR_Numbercr_number: TStringField
      FieldName = 'cr_number'
      ReadOnly = True
      Size = 255
    end
  ...
  object QPAYMENT: TZReadOnlyQuery
    Connection = DM.conn
    Params = <>
    Left = 347
    Top = 8
  ...
  object qBrowse: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select a.id_payment, a.no_payment, a.dt_payment, a.id_rek_gl, kk' +
        '.descriptions as nama_rekening, a.usr_upd, a.ispost, a.iscancel,' +
        ' b.nama_rekanan, '
      #9'a.usr_post, a.dt_post, a.nominal'
      'from accfin.payment a'
      'left join master.mrekanan b on b.kd_rekanan=a.kd_rekanan'
      'left join master.mrek_gl kk on kk.id_rek_gl=a.id_rek_gl'
    ...
    object qBrowsenama_rekening: TStringField
      FieldName = 'nama_rekening'
      Size = 255
    end
  ...
  object L_NotaSales: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select * from transaksi.fn_get_nota_piutang_tgl(:pid_sales,:ptgl' +
        '0,:ptgl1)')
    Params = <
      item
        DataType = ftUnknown
    ...
    object L_NotaSalesno_nota: TStringField
      FieldName = 'no_nota'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSalesdt_nota: TDateTimeField
      FieldName = 'dt_nota'
      ReadOnly = True
    end
    object L_NotaSalesremarks: TStringField
      FieldName = 'remarks'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSalesno_bukti: TStringField
      FieldName = 'no_bukti'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSaleskd_rekanan: TStringField
      FieldName = 'kd_rekanan'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSalesnama_rekanan: TStringField
      FieldName = 'nama_rekanan'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSalesdt_jth_tempo: TDateTimeField
      FieldName = 'dt_jth_tempo'
      ReadOnly = True
    end
    object L_NotaSalesid_rek_gl: TStringField
      FieldName = 'id_rek_gl'
      ReadOnly = True
      Size = 255
    end
    object L_NotaSalestotal: TFloatField
      FieldName = 'total'
      ReadOnly = True
    end
    object L_NotaSalespembayaran: TFloatField
      FieldName = 'pembayaran'
      ReadOnly = True
    end
    object L_NotaSalessisa: TFloatField
      FieldName = 'sisa'
      ReadOnly = True
    end
  end
  ...
  object kmtSelisih: TkbmMemTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
    ...
    Left = 582
    Top = 67
    object kmtSelisihselisih: TFloatField
      FieldName = 'selisih'
      DisplayFormat = '0.0,0'
    end
  end
  object dskmtSelisih: TDataSource
    DataSet = kmtSelisih
    Left = 598
    Top = 77
  end
