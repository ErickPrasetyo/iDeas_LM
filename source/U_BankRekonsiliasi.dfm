object BankRekonsiliasiFrm: TBankRekonsiliasiFrm
  Left = 199
  Top = 100
  Width = 1123
  Height = 507
  ...
  object grdProject: TcxGrid
    ...
    object grddbtvMaster: TcxGridDBTableView
      ...
      object grddbtvMasterjns_ttbg: TcxGridDBColumn
        Caption = 'Jenis'
        DataBinding.FieldName = 'jns_ttbg'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 100
      ...
      object grddbtvMasterdue_date: TcxGridDBColumn
        Caption = 'Jatuh Tempo'
      ...
      object grddbtvMasternama_rekening: TcxGridDBColumn
        Caption = 'Rekening'
      ...
      object grddbtvMasteriscair: TcxGridDBColumn
        Caption = 'Cair'
        DataBinding.FieldName = 'iscair'
      ...
      object grddbtvMasterdt_cair: TcxGridDBColumn
        Caption = 'Tgl Cair'
        DataBinding.FieldName = 'dt_cair'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 80
      end
      object grddbtvMasterno_bkbb: TcxGridDBColumn
        Caption = 'Bo. BKBB'
        DataBinding.FieldName = 'no_bkbb'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 100
      end
      object grddbtvMasternominal: TcxGridDBColumn
        Caption = 'Nominal'
    ...
    object grdProjectLevelMaster: TcxGridLevel
  ...
  object pnlTop: TSCPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 35
      AutoSize = False
      Caption = 'Form ini mewakili Bank Rekonsiliasi'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
        ...
        'select a.id_payment, a.id_trans, a.no_payment, a.dt_payment, a.d' +
        'ue_date, a.iscair, a.dt_cair, a.no_bkbb, a.nominal, b.descriptio' +
        'ns as nama_rekening, c.nama_rekanan, a.jns_ttbg'
      'from accfin.payment a'
      'left join master.mrek_gl b on b.id_rek_gl=a.id_rek_gl'
      'left join master.mrekanan c on c.kd_rekanan=a.kd_rekanan'
      
        'where a.iscancel='#39'0'#39' and a.isdelete='#39'0'#39' and a.id_trans in('#39'403'#39',' +
        #39'404'#39') and a.jns_ttbg='#39'CEK/BG'#39
  ...
  object frxRepMaster: TfrxReport
    ...
    ReportOptions.LastChange = 40207.591335937500000000
  ...
  object PopUp: TAdvPopupMenu
    ...
    Left = 445
    Top = 55
    object Issued1: TMenuItem
      Caption = 'Cair'
      OnClick = Issued1Click
    end
  end
end
