object SettingNeracaFrm: TSettingNeracaFrm
  Left = 259
  Top = 137
  Width = 738
  Height = 662
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini digunakan untuk merancang bentuk neraca berdasarkan pen' +
        'gelompokan kode rekening perkiraan. Sehingga nantinya bentuk ner' +
        'aca sesuai dengan yang diinginkan'
      Color = clWhite
    ...
    object tsBrowse: TcxTabSheet
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterjenis: TcxGridDBColumn
            Caption = 'Jenis'
    ...
    object tsDetail: TcxTabSheet
      ...
      object grdDetail: TcxGrid
        ...
        object grddbtvDetail: TcxGridDBTableView
          ...
          object grddbtvDetailgolongan: TcxGridDBColumn
            Caption = 'Jenis'
          ...
          object grddbtvDetailisdetail: TcxGridDBColumn
            Caption = 'Detail'
      ...
      object pnlDetailData: TPanel
        ...
        object edtUserName: TcxDBTextEdit
          Left = 111
          Top = 8
          DataBinding.DataField = 'id_rek_neraca'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'select * from accfin.mrek_neraca')
    Params = <>
    Left = 180
    Top = 10
    object Masterid_rek_neraca: TStringField
    ...
    object Masternperiode_ini: TFloatField
      FieldName = 'nperiode_ini'
      Required = True
    end
    object Masternperiode_lalu: TFloatField
      FieldName = 'nperiode_lalu'
      Required = True
    end
  ...
  object Detail: TZQuery
    ...
    CachedUpdates = True
    SQL.Strings = (
      'select id_rek_gl, descriptions, golongan, isdetail '
      'from master.mrek_gl'
      'where  id_rek_neraca=:id_rek_neraca'
      'order by id_rek_gl')
    Params = <
      item
        DataType = ftUnknown
    ...
    object Detailgolongan: TStringField
      FieldName = 'golongan'
      Size = 10
    end
    object Detailisdetail: TStringField
      FieldName = 'isdetail'
      Required = True
      Size = 1
    end
