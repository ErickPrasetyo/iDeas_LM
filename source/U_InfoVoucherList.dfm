object InfoVoucherListFrm: TInfoVoucherListFrm
  Left = 189
  Top = 121
  Width = 1024
  Height = 577
        ...
        object grddbtvAP_List: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              Format = '0.0,0'
              Kind = skSum
              FieldName = 'total_vocer'
              Column = grddbtvAP_Listtotal_vocer
            end
            item
              Kind = skCount
              FieldName = 'no_nota'
          ...
          object grddbtvAP_Listno_evocer: TcxGridDBColumn
          ...
          object grddbtvAP_Listno_mvocer: TcxGridDBColumn
          ...
          object grddbtvAP_Listtotal_vocer: TcxGridDBColumn
            Caption = 'Total Voucher'
            DataBinding.FieldName = 'total_vocer'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 112
  ...
  object Master: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'SELECT a.* FROM  transaksi.fn_rep_voucher_list(:ptgl0, :ptgl1) a')
    Params = <
      item
        DataType = ftString
        Name = 'ptgl0'
    ...
    object Mastertotal_vocer: TFloatField
      FieldName = 'total_vocer'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
  ...
  object qrySUM_OUTLET: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'z.kd_rekanan, '
      'x.nama_rekanan,'
      'sum(z.evocer) as total_e,'
      'sum(z.mvocer) as total_m,'
      'sum(z.total_vocer) as total'
      ''
      ''
      'FROM '
    ...
    object qrySUM_OUTLETtotal_e: TFloatField
      FieldName = 'total_e'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object qrySUM_OUTLETtotal_m: TFloatField
      FieldName = 'total_m'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
  ...
  object qrySUM_SALES: TZReadOnlyQuery
    ...
    object qrySUM_SALEStotal_e: TFloatField
      FieldName = 'total_e'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object qrySUM_SALEStotal_m: TFloatField
      FieldName = 'total_m'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
  ...
  object qryPrint: TZQuery
    ...
    object qryPrintno_evocer: TStringField
      FieldName = 'no_evocer'
      ReadOnly = True
      Size = 255
    end
    ...
    object qryPrintno_mvocer: TStringField
      FieldName = 'no_mvocer'
      ReadOnly = True
      Size = 255
    end
    ...
    object qryPrinttotal_vocer: TFloatField
      FieldName = 'total_vocer'
      ReadOnly = True
    end
  end
