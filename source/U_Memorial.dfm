object MemorialFrm: TMemorialFrm
  Left = 277
  Top = 83
  Width = 964
  Height = 622
      ...
      object pnlMaster: TSCPanel
        ...
        object cxGroupBox3: TcxGroupBox
          ...
          object edtJenis: TcxDBLookupComboBox
            Left = 53
            Top = 14
            DataBinding.DataField = 'peruntukan'
            DataBinding.DataSource = dsMaster
            ParentFont = False
  ...
  object L_Nota: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'UNION'
        ...
        'select a.no_nota, a.dt_nota, a.total, a.pembayaran, cast('#39'PIUTAN' +
        'G'#39' as character varying(10)) as jenis'
      'from accfin.vlook_ar a'
      'where kd_rekanan=:pid_rekanan'
      ''
      '')
    Params = <
