object SalesmanFrm: TSalesmanFrm
  Left = 242
  Top = 79
  Width = 881
  Height = 602
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 42
      AutoSize = False
      Caption = 'Form ini berisi daftar supplier yang menjadi salesman.'
      Color = clWhite
  ...
  object pgMaster: TcxPageControl
    ...
    object tsBrowse: TcxTabSheet
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterSALESM: TcxGridDBColumn
            Caption = 'Kode'
          ...
          object grddbtvMasterNAMA: TcxGridDBColumn
          ...
          object grddbtvMasterLBL: TcxGridDBColumn
            Caption = 'Golongan'
          ...
          object grddbtvMasterkd_sales: TcxGridDBColumn
            Caption = 'Kode Sales Org'
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlDetailSupplier: TRzPanel
        ...
        object edtKodeRekGL: TcxDBButtonEdit
          Left = 12
          Top = 140
          ...
          Properties.OnButtonClick = edtKodeRekGLPropertiesButtonClick
          TabOrder = 2
          OnKeyPress = EditKeyPress
          Width = 215
        end
        object edtKdSales: TRzDBEdit
          Left = 12
          Top = 186
          Width = 215
          Height = 19
        ...
        object edtGolongan: TcxDBButtonEdit
          Left = 223
          Top = 140
          DataBinding.DataField = 'lbl'
          DataBinding.DataSource = dsMaster
          Properties.Buttons = <
            item
              Default = True
          ...
          Properties.OnButtonClick = edtGolonganPropertiesButtonClick
          TabOrder = 3
          OnKeyPress = EditKeyPress
          Width = 186
        end
  ...
  object LookRekening: TwwLookupDialog
    Selected.Strings = (
      'id_rek_gl'#9'25'#9'Kode'#9'F'
      'descriptions'#9'30'#9'Nama Rekening'#9'F')
  ...
  object qGolongan: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select  description'
      'from master.mparameter'
      'where param_kind ='#39'LABEL_SALES'#39)
    Params = <>
    Left = 458
    Top = 48
    object qGolongandescription: TStringField
      DisplayLabel = 'KODE'
      DisplayWidth = 100
      FieldName = 'description'
      Size = 100
  ...
  object LookLbl: TwwLookupDialog
    Selected.Strings = (
      'description'#9'100'#9'KODE'#9'F')
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = qGolongan
    Caption = 'Lookup Golongan'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
    Left = 468
