object NilaiPersediaanFrm: TNilaiPersediaanFrm
  Left = 198
  Top = 74
  Width = 1103
  Height = 623
  ...
  object grdItem: TcxGrid
    ...
    object grdItemDBBandedTableView1: TcxGridDBBandedTableView
      ...
      object grdItemDBBandedTableView1Column4: TcxGridDBBandedColumn
        Caption = 'Harga Jual'
      ...
      object grdItemDBBandedTableView1Column5: TcxGridDBBandedColumn
        Caption = 'Nilai Keluar'
        DataBinding.FieldName = 'nilai_keluar'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Styles.Header = cxStyle1
        Position.BandIndex = 1
      ...
      object grdItemDBBandedTableView1Column6: TcxGridDBBandedColumn
        Caption = 'Nilai Akhir'
        DataBinding.FieldName = 'nilai_akhir'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Styles.Header = cxStyle1
        Position.BandIndex = 1
  ...
  object Master: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        't, a.parent_name, b.rasio,'
      'b.hrg_jual, (b.hrg_jual*a.total_ot) as nilai_akhir,'
      'a.stok_awal, a.total_in, a.total_ot, a.stok_akhir'
    ...
    object Masternilai_akhir: TFloatField
      FieldName = 'nilai_akhir'
      ReadOnly = True
      DisplayFormat = ',0'
    end
    object Masternilai_keluar: TFloatField
      FieldName = 'nilai_keluar'
      DisplayFormat = ',0'
    end
  end
  ...
  object kmtMaster: TkbmMemTable
    ...
    object kmtMasterstok_keluar: TStringField
      FieldName = 'stok_keluar'
    end
    object kmtMasterstok_awal: TStringField
      FieldName = 'stok_awal'
    end
    object kmtMasterstok_akhir: TStringField
      FieldName = 'stok_akhir'
    end
    object kmtMasterstok_masuk: TStringField
      FieldName = 'stok_masuk'
    end
    object kmtMasterhrg_jual: TStringField
      FieldName = 'hrg_jual'
    end
    object kmtMasternilai_akhir: TStringField
      FieldName = 'nilai_akhir'
    end
    object kmtMasternilai_keluar: TStringField
      FieldName = 'nilai_keluar'
    end
  end
