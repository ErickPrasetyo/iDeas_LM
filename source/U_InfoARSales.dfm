object InfoARSalesFrm: TInfoARSalesFrm
  Left = 236
  Top = 161
  Width = 1024
  Height = 577
  ...
  object SCPanel3: TSCPanel
    ...
    object rgStatus: TRzGroupBox
      ...
      TabOrder = 4
      Transparent = True
      object RB_SEMUA: TcxRadioButton
        Left = 10
        Top = 16
        Width = 89
        Height = 17
        ...
        TabOrder = 0
        TabStop = True
        OnClick = RB_SEMUAClick
        Transparent = True
      end
      object RB_SDH_DIBAYAR: TcxRadioButton
        Left = 103
        Top = 16
        Width = 90
        Height = 17
      ...
      object RB_BLM_DIBAYAR: TcxRadioButton
        Left = 103
        Top = 37
        Width = 89
        Height = 17
      ...
      object RB_BLM_LUNAS: TcxRadioButton
        Left = 210
        Top = 17
        Width = 90
        Height = 17
      ...
      object RB_SALDO_BLM_LUNAS: TcxRadioButton
        Left = 211
        Top = 37
        Width = 111
        Height = 17
        Caption = 'Saldo Belum Lunas'
        TabOrder = 4
        OnClick = RB_SEMUAClick
        Transparent = True
      end
    end
    object edtSaleman: TcxButtonEdit
      Left = 79
      Top = 37
      Properties.Buttons = <
        item
      ...
      Properties.OnButtonClick = edtSalemanPropertiesButtonClick
      TabOrder = 5
      Width = 68
    end
  end
  object grdOutlet: TcxGrid
    ...
    object grddbtvOutlet: TcxGridDBTableView
      ...
      object grddbtvOutletno_nota: TcxGridDBColumn
        Caption = 'No. Nota'
      ...
      object grddbtvOutletno_bukti: TcxGridDBColumn
        Caption = 'No. Faktur'
      ...
      object grddbtvOutletdt_nota: TcxGridDBColumn
        Caption = 'Tanggal'
      ...
      object grddbtvOutletnama_sales: TcxGridDBColumn
        Caption = 'Salesman'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'SELECT a.*'
      'FROM  transaksi.fn_rep_ar_list(:ptgl1) a')
    Params = <
      item
        DataType = ftString
        Name = 'ptgl1'
  ...
  object kmtMaster: TkbmMemTable
    ...
    Left = 564
    Top = 302
    object kmtMasterno_nota: TStringField
      FieldName = 'no_nota'
      Size = 255
    end
    object kmtMasterdt_nota: TDateTimeField
      FieldName = 'dt_nota'
    end
    ...
    object kmtMasterno_bukti: TStringField
      FieldName = 'no_bukti'
      Size = 255
    end
    object kmtMastertotal: TFloatField
      FieldName = 'total'
    end
    object kmtMasterpembayaran: TFloatField
      FieldName = 'pembayaran'
    end
    object kmtMastersisa: TFloatField
      FieldName = 'sisa'
    end
  end
end
