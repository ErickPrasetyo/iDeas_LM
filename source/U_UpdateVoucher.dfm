object UpdateVoucherFrm: TUpdateVoucherFrm
  Left = 25
  Top = 224
  Width = 1028
  Height = 507
  Caption = 'Update Nomor && Nilai Voucher'
  Color = clBtnFace
  ...
  object grdProject: TcxGrid
    ...
    object grddbtvMaster: TcxGridDBTableView
      ...
      object grddbtvMasterno_evocer: TcxGridDBColumn
        Caption = 'No. e-Voucher'
        DataBinding.FieldName = 'no_evocer'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 101
      ...
      object grddbtvMasterno_mvocer: TcxGridDBColumn
        Caption = 'No. m-Voucher'
        DataBinding.FieldName = 'no_mvocer'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 104
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.id_nota, a.no_nota, a.dt_nota, a.kd_rekanan, b.nama_rek' +
        'anan, a.id_division, c.description as nama_sales, a.total, a.no_' +
        'evocer, a.evocer, a.no_mvocer, a.mvocer '
      ...
      'WHERE a.id_trans='#39'201'#39' AND a.isdelete='#39'0'#39
  ...
  object PopUp: TAdvPopupMenu
    ...
    object mVoucher1: TMenuItem
      Caption = 'm-Voucher'
      OnClick = mVoucher1Click
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object HapuseVoucher1: TMenuItem
      Caption = 'Hapus e-Voucher'
      OnClick = HapuseVoucher1Click
    end
    object HapusmVoucher1: TMenuItem
      Caption = 'Hapus m-Voucher'
      OnClick = HapusmVoucher1Click
    end
  end
end
