object BukuBankFrm: TBukuBankFrm
  ...
  object SCPanel1: TSCPanel
    ...
    object edtSalAwal: TcxDBTextEdit
      Left = 881
      Top = 13
      DataBinding.DataField = 'saldo_awal'
  ...
  object pnlTop: TSCPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 35
      AutoSize = False
      Caption = 'Form ini mewakili Buku Bank'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object pnlFooter: TSCPanel
    ...
    object edtMutasi: TcxDBTextEdit
      ...
      DataBinding.DataSource = dsMutasi
      Properties.Alignment.Horz = taRightJustify
      Properties.Alignment.Vert = taVCenter
      Properties.ReadOnly = True
      Style.BorderStyle = ebsFlat
    ...
    object edtSalAkhir: TcxDBTextEdit
      Left = 884
      Top = 31
      DataBinding.DataField = 'saldo_akhir'
      DataBinding.DataSource = dsSaldo
      Properties.Alignment.Horz = taRightJustify
      Properties.Alignment.Vert = taVCenter
      Properties.ReadOnly = True
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      ...
      'where id_trans in ('#39'403'#39','#39'404'#39')'
      'and id_rek_gl=:pid_rek_gl'
      
        'and dt_payment between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and to_' +
        'timestamp(:ptgl1,'#39'dd/mm/yyyy'#39') +  interval '#39'23 hours 59 min'#39
      ''
      'order by id')
    Params = <
      item
    ...
    object Masternama_transaksi: TStringField
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object MemoPreparer: TfrxMemoView
          ...
          Height = 15.118120000000000000
          DataField = 'usr_print'
          DataSet = BankRekonsiliasiFrm.frxDBInfo
          DataSetName = 'frxDBRepInfo'
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object qryRek: TZQuery
    ...
    SQL.Strings = (
      'select a.*,'
        ...
        'coalesce((select sum(b.debet-b.kredit) from accfin.vpayment_deta' +
        'il b where b.id_rek_gl=a.id_rek_gl and b.dt_payment< to_timestam' +
        'p(:ptgl0,'#39'dd/mm/yyyy'#39')),0) as awal,'
      
        'coalesce((select sum(b.debet-b.kredit) from accfin.vpayment_deta' +
        'il b where b.id_rek_gl=a.id_rek_gl and b.dt_payment between to_t' +
        'imestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and to_timestamp(:ptgl1,'#39'dd/mm/yyy' +
        'y'#39') +  interval '#39'23 hours 59 min'#39' ),0) as berjalan '
      'from master.cash_bank_acc a'
      'where a.jenis='#39'BANK'#39
    ...
    object qryRekdescriptions: TStringField
    ...
    object qryRekberjalan: TFloatField
      FieldName = 'berjalan'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  ...
  object qrySaldo: TZQuery
    Connection = DM.conn
    BeforeOpen = qrySaldoBeforeOpen
    ...
    object qrySaldosaldo_awal: TFloatField
      FieldName = 'saldo_awal'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object qrySaldosaldo_akhir: TFloatField
      FieldKind = fkCalculated
  ...
  object qryMutasi: TZQuery
    ...
    object qryMutasimutasi: TFloatField
      FieldName = 'mutasi'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
