object LookHutangUliFrm: TLookHutangUliFrm
  Left = 197
  Top = 172
  Width = 1088
  Height = 522
  BorderStyle = bsSizeToolWin
  Caption = 'Daftar Hutang ULI'
  Color = clWindow
  Ctl3D = False
  ...
  object gridItemPR: TcxGrid
    ...
    object grdDBTV_ItemPR: TcxGridDBTableView
      ...
      object grdDBTV_ItemPRdt_due: TcxGridDBColumn
      ...
      object grdDBTV_ItemPRjenis_pas: TcxGridDBColumn
        Caption = 'Jumlah'
        DataBinding.FieldName = 'sisa_idr'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Options.Filtering = False
  ...
  object LPR_Item_Status: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select cast('#39'0'#39' as varchar(1)) as ispilih, a.*, b.nama_rekanan'
    ...
    object LPR_Item_Statusno_doc: TStringField
      FieldName = 'no_doc'
      Size = 30
    end
    object LPR_Item_Statusdt_doc: TDateTimeField
      FieldName = 'dt_doc'
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object LPR_Item_Statusid_curr: TStringField
      FieldName = 'id_curr'
      Size = 3
    end
    object LPR_Item_Statuskurs: TFloatField
      FieldName = 'kurs'
    end
    object LPR_Item_Statusremarks: TStringField
      FieldName = 'remarks'
      Size = 255
    end
    object LPR_Item_Statusno_bukti: TStringField
      FieldName = 'no_bukti'
      Size = 255
    end
    ...
    object LPR_Item_Statusdt_due: TDateTimeField
      FieldName = 'dt_due'
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object LPR_Item_Statustotal_in: TFloatField
      FieldName = 'total_in'
    end
    object LPR_Item_Statustotal_idr: TFloatField
      FieldName = 'total_idr'
    end
    ...
    object LPR_Item_Statuspembayaran: TFloatField
      FieldName = 'pembayaran'
    end
    object LPR_Item_Statuspembayaran_idr: TFloatField
      FieldName = 'pembayaran_idr'
    end
    object LPR_Item_Statussisa: TFloatField
      FieldName = 'sisa'
    end
    object LPR_Item_Statussisa_idr: TFloatField
      FieldName = 'sisa_idr'
    end
  ...
  object kmtPR: TkbmMemTable
    ...
    object kmtPRno_doc: TStringField
      FieldName = 'no_doc'
      Size = 30
    end
    object kmtPRdt_doc: TDateTimeField
      FieldName = 'dt_doc'
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object kmtPRid_curr: TStringField
      FieldName = 'id_curr'
      Size = 3
    end
    object kmtPRkurs: TFloatField
      FieldName = 'kurs'
    end
    object kmtPRremarks: TStringField
      FieldName = 'remarks'
      Size = 255
    end
    object kmtPRno_bukti: TStringField
      FieldName = 'no_bukti'
      Size = 255
    end
    ...
    object kmtPRdt_due: TDateTimeField
      FieldName = 'dt_due'
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object kmtPRtotal_in: TFloatField
      FieldName = 'total_in'
      DisplayFormat = '0.0,0'
    end
    object kmtPRtotal_idr: TFloatField
      FieldName = 'total_idr'
      DisplayFormat = '0.0,0'
    end
    ...
    object kmtPRpembayaran: TFloatField
      FieldName = 'pembayaran'
      DisplayFormat = '0.0,0'
    end
    object kmtPRpembayaran_idr: TFloatField
      FieldName = 'pembayaran_idr'
      DisplayFormat = '0.0,0'
    end
    object kmtPRsisa: TFloatField
      FieldName = 'sisa'
      DisplayFormat = '0.0,0'
    end
    object kmtPRsisa_idr: TFloatField
      FieldName = 'sisa_idr'
      DisplayFormat = '0.0,0'
    end
