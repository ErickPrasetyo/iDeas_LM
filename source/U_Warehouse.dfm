object WarehouseFrm: TWarehouseFrm
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pgcWarehouse: TcxPageControl
    Left = 0
    Top = 40
    Width = 545
    Height = 223
    ...
    Style = 8
    TabOrder = 0
    OnPageChanging = pgcWarehousePageChanging
    ClientRectBottom = 223
    ClientRectRight = 545
    ClientRectTop = 24
    object tsBowse: TcxTabSheet
      Caption = 'Browse'
      ImageIndex = 0
      object grdWarehouse: TcxGrid
        Left = 0
        Top = 0
        Width = 545
        Height = 199
        Align = alClient
        TabOrder = 0
        object grddbtv_Warehouse: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          OnCellDblClick = grddbtv_WarehouseCellDblClick
          DataController.DataSource = dsDimension
          ...
          object grddbtv_Warehouseid_warehouse: TcxGridDBColumn
            Caption = 'KODE'
          ...
          object grddbtv_Warehousedescription: TcxGridDBColumn
            Caption = 'DISKRIPSI'
        ...
        object grdlvlWarehouse: TcxGridLevel
          GridView = grddbtv_Warehouse
        end
      end
    end
    object tsDetail: TcxTabSheet
      Caption = 'Detail'
      ImageIndex = 1
      object grdDBV_Dimension: TcxDBVerticalGrid
        Left = 0
        Top = 0
        Width = 545
        Height = 199
        ...
        TabOrder = 0
        DataController.DataSource = dsDimension
        object grdDBV_Dimensionid_warehouse: TcxDBEditorRow
          Properties.Caption = 'Kode'
          Properties.DataBinding.FieldName = 'id_warehouse'
        end
        object grdDBV_Dimensiondescription: TcxDBEditorRow
          Properties.Caption = 'Diskripsi'
