object NotaHutangFrm: TNotaHutangFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 20
      AutoSize = False
      Caption = 'Form ini berisi Nota Hutang dari Supplier'
      Color = clWhite
    ...
    object tsBrowse: TcxTabSheet
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterdt_jth_tempo: TcxGridDBColumn
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object rgRekanan: TcxGroupBox
          ...
          object LookRekanan: TcxDBLookupComboBox
            Left = 52
            Top = 33
            ...
            Properties.KeyFieldNames = 'kd_rekanan'
            ...
            Properties.ListSource = dsQSupplier
            Properties.PostPopupValueOnTab = True
            TabOrder = 0
            OnKeyPress = EditKeyPress
            Width = 189
          end
          object edtJnsTrans: TcxDBComboBox
            Left = 52
            Top = 84
        ...
        object rgPayment: TcxGroupBox
          ...
          object edtDueDate: TcxDBDateEdit
            Left = 79
            Top = 64
            DataBinding.DataField = 'dt_jth_tempo'
            DataBinding.DataSource = dsMaster
            Style.BorderStyle = ebsOffice11
          ...
          object edtNOBukti: TcxDBTextEdit
            Left = 79
            Top = 88
            DataBinding.DataField = 'no_bukti'
            DataBinding.DataSource = dsMaster
            Style.BorderStyle = ebsOffice11
            Style.Shadow = False
            StyleFocused.BorderStyle = ebsThick
          ...
          object edtNhari: TcxDBSpinEdit
            Left = 79
            Top = 39
            DataBinding.DataField = 'n_hari'
            DataBinding.DataSource = dsMaster
            Properties.OnChange = edtNhariPropertiesChange
            TabOrder = 3
            OnKeyPress = EditKeyPress
            Width = 105
          end
      ...
      object SCPanel1: TSCPanel
        ...
        object Label25: TLabel
          ...
          Width = 133
          Height = 14
          Caption = 'Potongan Non Promosi [Rp.]'
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -11
          Font.Name = 'Arial'
        ...
        object edtDiscountNon: TcxDBTextEdit
          Left = 490
          Top = 3
          DataBinding.DataField = 'disc_psn'
          DataBinding.DataSource = dsMaster
          ParentFont = False
          Style.BorderStyle = ebsOffice11
          Style.Font.Charset = ANSI_CHARSET
        ...
        object edtTotal: TcxDBTextEdit
          Left = 490
          Top = 47
          DataBinding.DataField = 'total_potongan'
          DataBinding.DataSource = dsMaster
          ParentFont = False
          Style.BorderStyle = ebsOffice11
          Style.Font.Charset = ANSI_CHARSET
        ...
        object edtDiskon: TcxDBTextEdit
          Left = 729
          Top = 9
          DataBinding.DataField = 'disc_total'
          DataBinding.DataSource = dsMaster
          ParentFont = False
          Properties.OnChange = edtDiskonPropertiesChange
          Style.BorderStyle = ebsOffice11
          Style.Font.Charset = ANSI_CHARSET
          Style.Font.Color = clRed
          Style.Font.Height = -11
      ...
      object SCPanel2: TSCPanel
        ...
        object grdDetail: TcxGrid
          ...
          object grdDBTVDetail: TcxGridDBBandedTableView
            NavigatorButtons.ConfirmDelete = False
            OnEditKeyDown = grdDBTVDetailEditKeyDown
            OnEditKeyPress = grdDBTVDetailEditKeyPress
            ...
            object grdDBTVDetailnomor: TcxGridDBBandedColumn
              Caption = 'No.'
            ...
            object grdDBTVDetailkd_item: TcxGridDBBandedColumn
              Caption = 'Kode'
              DataBinding.FieldName = 'kd_item'
              OnGetPropertiesForEdit = grdDBTVDetailkd_itemGetPropertiesForEdit
              HeaderAlignmentHorz = taCenter
              HeaderAlignmentVert = vaCenter
              Options.Filtering = False
              Options.FilteringFilteredItemsList = False
            ...
            object grdDBTVDetailnama_item: TcxGridDBBandedColumn
              Caption = 'Diskripsi'
              DataBinding.FieldName = 'diskripsi'
              OnGetPropertiesForEdit = grdDBTVDetailnama_itemGetPropertiesForEdit
              HeaderAlignmentHorz = taCenter
              HeaderAlignmentVert = vaCenter
              Options.Filtering = False
              Options.FilteringFilteredItemsList = False
            ...
            object grdDBTVDetailhrg_beli_karton: TcxGridDBBandedColumn
              Caption = 'Harga Beli'
            ...
            object grdDBTVDetailsub_total: TcxGridDBBandedColumn
              Caption = 'Sub Total'
            ...
            object grdDBTVDetailpromo: TcxGridDBBandedColumn
              Caption = 'Promo'
            ...
            object grdDBTVDetailColumn3: TcxGridDBBandedColumn
              Caption = 'Qty'
            ...
            object grdDBTVDetailColumn1: TcxGridDBBandedColumn
              Caption = 'Satuan'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      ...
      'from transaksi.nota'
        ...
        'where id_nota=:id_nota and id_trans in('#39'101'#39', '#39'104'#39', '#39'105'#39', '#39'106' +
        #39')')
    Params = <
      item
        DataType = ftUnknown
    ...
    object Mastertotal_potongan: TFloatField
    ...
    object fltfldMastertot2: TFloatField
      FieldKind = fkCalculated
      FieldName = 'tot2'
      Calculated = True
    end
    ...
    object Masterdisc_total: TFloatField
      ...
      Required = True
      OnChange = Masterdisc_totalChange
      DisplayFormat = ',0'
    end
  end
  object Detail: TZQuery
    ...
    object Detailharga_net: TFloatField
      FieldKind = fkCalculated
      FieldName = 'harga_net'
      DisplayFormat = '0.0,0'
      Calculated = True
  ...
  object QSupplier: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select kd_rekanan, nama_rekanan, plafon, alamat, kota '
      'from master.mrekanan'
      'where jenis='#39'SUPPLIER'#39' and is_aktif='#39'1'#39)
    Params = <>
    Left = 545
    Top = 10
    object QSupplierkd_rekanan: TStringField
      DisplayLabel = 'Kode'
      DisplayWidth = 15
      FieldName = 'kd_rekanan'
      Required = True
    end
    object QSuppliernama_rekanan: TStringField
    ...
    object QSupplieralamat: TStringField
      DisplayLabel = 'Alamat'
      DisplayWidth = 35
      FieldName = 'alamat'
      Required = True
    ...
    object QSupplierkota: TStringField
      DisplayLabel = 'Kota'
      DisplayWidth = 10
      FieldName = 'kota'
      Size = 30
    end
    object QSupplierplafon: TFloatField
      FieldName = 'plafon'
      ReadOnly = True
      Visible = False
    end
  ...
  object qrySubTotal: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select sum((qty_karton*(hrg_beli_karton*(1-((disc_psn+disc_rp)/1' +
        '00))))+(qty_biji*hrg)) as sub_total '
  ...
  object kmtMaster: TkbmMemTable
    ...
    object kmtMastertotal_diskon: TStringField
  ...
  object kmtDetail: TkbmMemTable
    ...
    object kmtDetailqty_karton: TFloatField
      FieldName = 'qty_karton'
    end
    object kmtDetailsatuan_beli: TStringField
      FieldName = 'satuan_beli'
    end
  end
  ...
  object qryITEM: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select a.kd_item, a.nama_item, a.satuan_beli as satuan, a.hrg_be' +
        'li,'
      'a.rasio, a.id_rek_persediaan'
      'from master.item a'
    ...
    object qryITEMsatuan: TStringField
      FieldName = 'satuan'
      Size = 80
    end
    ...
    object qryITEMid_rek_persediaan: TStringField
      FieldName = 'id_rek_persediaan'
      Size = 120
    end
  end
  object rptPOLokal: TfrxReport
    Version = '5.2.3'
    ...
    ReportOptions.LastChange = 39684.561385451400000000
    ...
    Datasets = <
      item
        DataSet = frxDBkmtDetail
        DataSetName = 'frxDBkmtDetail'
      end
      item
        DataSet = frxDBkmtMaster
        DataSetName = 'frxDBkmtMaster'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo13: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBkmtMaster."supplier_address"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo55: TfrxMemoView
          ...
          Memo.UTF8 = (
            'Dengan hormat,'
            'Dengan ini kami mohon kirimkan barang sebagai berikut :')
          ParentFont = False
        end
        object Memo8: TfrxMemoView
          Top = 22.897650000000000000
          Width = 600.945160160000000000
          Height = 18.897650000000000000
        ...
        object Memo43: TfrxMemoView
          ...
          Width = 283.464640160000000000
          Height = 18.897650000000000000
          DataField = 'supplier_fax'
          DataSet = frxDBkmtMaster
          DataSetName = 'frxDBkmtMaster'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = 'mmmm dd, yyyy'
        ...
        object Memo3: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBkmtMaster."supplier_contact"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo23: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '1. Pembayaran                  :  [frxDBkmtMaster."payment_terms' +
              '"]'
            '2. Barang tersebut mohon dikirm ke alamat : '
            '     [frxDBkmtMaster."delivery_place"]'
            ''
            
              '3. Dan mohon untuk pengiriman barang dilampiri :  [frxDBkmtMaste' +
              'r."remarks"]'
            ''
            '')
          ParentFont = False
        ...
        object Memo6: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              'Demikian kami sampaikan atas perhatiannya serta kerjasamanya yan' +
              'g baik kami ucapkan terima kasih.')
          ParentFont = False
        end
        ...
        object MemoApprovedBy: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'Surabaya, [frxDBkmtMaster."dt_approved_1"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo7: TfrxMemoView
          Left = 18.897650000000000000
          Top = 287.244279999999900000
          Width = 234.330860000000000000
      ...
      object Header1: TfrxHeader
        ...
        Top = 18.897650000000000000
        Width = 699.213050000000000000
        object MemoHeader: TfrxMemoView
  ...
  object qRekap: TZQuery
    ...
    SQL.Strings = (
        ...
        'p, a.vat_num, a.total, a.sub_total'
      'from transaksi.nota a'
      'left join master.mrekanan b on b.kd_rekanan=a.kd_rekanan'
      
        'where a.isdelete='#39'0'#39' and a.iscancel='#39'0'#39' and a.id_trans in(:id_tr' +
        'ans, '#39'104'#39', '#39'105'#39', '#39'106'#39')'
    ...
    object qRekapsub_total: TFloatField
      FieldName = 'sub_total'
      Required = True
    end
  end
  ...
  object dsQSupplier: TDataSource
    DataSet = QSupplier
    Left = 545
    Top = 40
  end
  ...
  object qBrowse: TZQuery
    ...
    SQL.Strings = (
        ...
        'scancel, b.nama_rekanan, a.jns_transaksi, a.cara_bayar, a.dt_jth' +
        '_tempo, '
      
        #9'a.no_bukti, a.disc_rp, a.disc_psn, a.total, a.vat_num, a.sub_to' +
        'tal'
      'FROM transaksi.nota a'
      'LEFT JOIN master.mrekanan b ON b.kd_rekanan=a.kd_rekanan'
      
        'WHERE a.isdelete='#39'0'#39' and a.id_trans in(:id_trans, '#39'104'#39', '#39'105'#39', ' +
        #39'106'#39')'
      
        'and a.dt_ins between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and to_ti' +
        'mestamp(:ptgl1,'#39'dd/mm/yyyy'#39') +  interval '#39'23 hours 59 min'#39)
    Params = <
      item
        DataType = ftUnknown
        Name = 'id_trans'
    ...
    object qBrowsedisc_psn: TFloatField
      FieldName = 'disc_psn'
      Visible = False
      DisplayFormat = '0.0,0'
    end
  ...
  object ER: TcxEditRepository
    ...
    object ER_LCB_ITEM_KODE: TcxEditRepositoryLookupComboBoxItem
      ...
      Properties.PostPopupValueOnTab = True
      Properties.OnCloseUp = ER_LCB_ITEM_KODEPropertiesCloseUp
      Properties.OnInitPopup = ER_LCB_ITEM_KODEPropertiesInitPopup
    end
  end
  ...
  object LookBrowse: TwwLookupDialog
    Selected.Strings = (
      'no_nota'#9'30'#9'No. Invoice'#9'F'
      'no_bukti'#9'30'#9'No. Faktur'#9'F')
  ...
  object qPPN: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select * from master.ppn')
    Params = <>
    Left = 1092
    Top = 184
    object qPPNppn_psn: TFloatField
      FieldName = 'ppn_psn'
      Required = True
    end
    object qPPNppn_dec: TFloatField
      FieldName = 'ppn_dec'
      Required = True
    end
  end
  ...
  object item: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'a.rasio, a.id_rek_persediaan'
      'from master.item a'
      'where a.isdetail='#39'1'#39'  and a.kd_item=:kd_item'
      'order by a.kd_item')
    Params = <
      item
        DataType = ftUnknown
    ...
    object itemkd_item: TStringField
      FieldName = 'kd_item'
      Required = True
      Size = 200
    end
    object itemnama_item: TStringField
      FieldName = 'nama_item'
      Size = 1020
    end
    object itemsatuan: TStringField
      FieldName = 'satuan'
      Size = 80
    end
    object itemhrg_beli: TFloatField
      FieldName = 'hrg_beli'
      Required = True
    end
    object itemrasio: TFloatField
      FieldName = 'rasio'
      Required = True
    end
    object itemid_rek_persediaan: TStringField
      FieldName = 'id_rek_persediaan'
      Size = 120
    end
  end
