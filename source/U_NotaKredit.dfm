object NotaKreditFrm: TNotaKreditFrm
  Left = 229
  Top = 67
  Width = 1019
  Height = 631
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 20
      AutoSize = False
      Caption = 'Form ini berisi Nota Kredit/Retur dari Customer'
      Color = clWhite
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Column = grddbtvMasterpromo_barang
            end
            item
              Format = '0.0,0'
              Kind = skSum
              FieldName = 'promo_uang'
              Column = grddbtvMasterpromo_uang
            end
            item
              Format = '0.0,0'
              Kind = skSum
            ...
            item
              ...
              Kind = skSum
              FieldName = 'evocer'
              Column = grddbtvMasterevocer
            end
            item
              Format = '0.0,0'
              Kind = skSum
              FieldName = 'mvocer'
              Column = grddbtvMastermvocer
            end
            item
              Kind = skCount
              FieldName = 'id_nota'
          ...
          object grddbtvMasternota_diretur: TcxGridDBColumn
            Caption = 'Nota Diretur'
            DataBinding.FieldName = 'nota_diretur'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 69
          end
          object grddbtvMasterkd_rekanan: TcxGridDBColumn
          ...
          object grddbtvMasterid_division: TcxGridDBColumn
            Caption = 'Kd. Sales'
          ...
          object grddbtvMasternama_sales: TcxGridDBColumn
            Caption = 'Salesman'
          ...
          object grddbtvMasterpromo_barang: TcxGridDBColumn
          ...
          object grddbtvMasterpromo_uang: TcxGridDBColumn
            Caption = 'Promo Uang'
          ...
          object grddbtvMasterevocer: TcxGridDBColumn
            Caption = 'e-Voucher'
            DataBinding.FieldName = 'evocer'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          end
          object grddbtvMastermvocer: TcxGridDBColumn
            Caption = 'm-Voucher'
      ...
      object pnlMaster: TSCPanel
        ...
        object cxGroupBox2: TcxGroupBox
          ...
          object edtNOBukti: TcxDBTextEdit
            Left = 243
            Top = 14
            DataBinding.DataField = 'nota_diretur'
            DataBinding.DataSource = dsMaster
            Style.BorderStyle = ebsOffice11
            Style.Shadow = False
            StyleFocused.BorderStyle = ebsThick
          ...
          object edtPromoUang: TcxDBTextEdit
            Left = 244
            Top = 35
            DataBinding.DataField = 'promo_uang'
            DataBinding.DataSource = dsMaster
            Style.BorderStyle = ebsOffice11
            Style.Shadow = False
            StyleFocused.BorderStyle = ebsThick
          ...
          object edtPromoBarang: TcxDBTextEdit
            Left = 244
            Top = 56
            DataBinding.DataField = 'promo_uang'
            DataBinding.DataSource = dsMaster
        ...
        object edtKodeRek: TcxDBLookupComboBox
          Left = 106
          Top = 123
        ...
        object cxGroupBox3: TcxGroupBox
          ...
          object edtSaleman: TcxDBLookupComboBox
            Left = 51
            Top = 35
            DataBinding.DataField = 'nama_salesman'
            DataBinding.DataSource = dsMaster
            Properties.KeyFieldNames = 'id_division'
            Properties.ListColumns = <
              item
      ...
      object SCPanel2: TSCPanel
        ...
        object grdFP_Detail: TcxGrid
          ...
          object grddbtvFP_Detail: TcxGridDBBandedTableView
            ...
            object grddbtvFP_Detailispromo: TcxGridDBBandedColumn
              Caption = 'Promo'
              DataBinding.FieldName = 'ispromo'
              OnGetPropertiesForEdit = grddbtvFP_DetailispromoGetPropertiesForEdit
              HeaderAlignmentHorz = taCenter
              HeaderAlignmentVert = vaCenter
              Options.Filtering = False
              Options.FilteringFilteredItemsList = False
            ...
            object grddbtvFP_Detailstatus: TcxGridDBBandedColumn
              Caption = 'Status'
            ...
            object grddbtvFP_Detailid_rek_gl: TcxGridDBBandedColumn
              Caption = 'Kode. rek. [Dn]'
              DataBinding.FieldName = 'id_rek_gl'
              OnGetPropertiesForEdit = grddbtvFP_Detailid_rek_glGetPropertiesForEdit
              HeaderAlignmentHorz = taCenter
              HeaderAlignmentVert = vaCenter
              Options.Filtering = False
              Options.FilteringFilteredItemsList = False
            ...
            object grddbtvFP_Detailqty_ot_karton: TcxGridDBBandedColumn
              Caption = 'Karton'
            ...
            object grddbtvFP_Detailqty_ot_lusin: TcxGridDBBandedColumn
              Caption = 'Lusin'
            ...
            object grddbtvFP_Detailhrg_jual_karton: TcxGridDBBandedColumn
              Caption = 'Karton'
  ...
  object qryITEM: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select a.kd_item, a.nama_item, a.satuan_beli as satuan, '
      'a.hrg_beli, a.hrg_jual, a.rasio, a.id_rek_persediaan'
      'from master.item a'
  ...
  object qBrowse: TZQuery
    ...
    SQL.Strings = (
        ...
        'scancel, b.nama_rekanan, a.cara_bayar, a.dt_jth_tempo, a.nota_di' +
        'retur, a.promo_barang, '
      
        #9'a.promo_uang, a.disc_rp, a.total, a.id_division, c.description ' +
        'as nama_sales, a.sub_total,  a.evocer, a.mvocer, a.vat_num, a.kd' +
        '_rekanan'
      'FROM transaksi.nota a'
      'LEFT JOIN master.mrekanan b ON b.kd_rekanan=a.kd_rekanan'
    ...
    object qBrowseno_nota: TStringField
      DisplayLabel = 'No. Retur'
      DisplayWidth = 30
      FieldName = 'no_nota'
      Size = 30
    end
    object qBrowsenota_diretur: TStringField
      DisplayLabel = 'No. Nota Diretur'
      DisplayWidth = 30
      FieldName = 'nota_diretur'
      Size = 30
    end
    ...
    object qBrowsenama_sales: TStringField
  ...
  object ER: TcxEditRepository
    ...
    object ER_CB_PROMO: TcxEditRepositoryComboBoxItem
      Properties.DropDownSizeable = True
      Properties.Items.Strings = (
        '0'
        'B'
  ...
  object LookBrowse: TwwLookupDialog
    Selected.Strings = (
      'no_nota'#9'30'#9'No. Retur'#9'F'
      'nota_diretur'#9'30'#9'No. Nota Diretur'#9'F'
