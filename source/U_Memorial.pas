...
begin
   try
    ...
    sts_dlg.Show;
    try
        MemorialFrm:= TMemorialFrm.Create(Application);
        sts_dlg.Progress_It;
        with MemorialFrm do begin
...
procedure TMemorialFrm.CloneDetail;
begin
...
function TMemorialFrm.CheckDetail(id_item: string): Boolean;
begin
  Result:= False;
  try
...
procedure TMemorialFrm.UpdateView;
...
function TMemorialFrm.CheckEditRight(var msg: string): Boolean;
begin
  Result:= True;
  msg:= '';
...
function TMemorialFrm.CheckDeleteRight(var msg: string): Boolean;
begin
  Result:= True;
  msg:= '';
...
procedure TMemorialFrm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
Action:= caFree;
end;

procedure TMemorialFrm.FormCloseQuery(Sender: TObject;
...
procedure TMemorialFrm.actCloseExecute(Sender: TObject);
begin
   Close;
end;

procedure TMemorialFrm.actAddExecute(Sender: TObject);
begin
...
procedure TMemorialFrm.actEditExecute(Sender: TObject);
begin
  if pgTransaction.ActivePageIndex=0 then
     pgTransaction.ActivePageIndex:= 1;
...
procedure TMemorialFrm.actDeleteExecute(Sender: TObject);
begin
  if pgTransaction.ActivePageIndex=0 then
     pgTransaction.ActivePageIndex:= 1;
...
procedure TMemorialFrm.actRefreshExecute(Sender: TObject);
begin
  DBMode:= dmNone;
  try
    Master.Close;
...
procedure TMemorialFrm.actSaveExecute(Sender: TObject);
var s:String;
begin
...
procedure TMemorialFrm.DetailBeforeInsert(DataSet: TDataSet);
begin
  if Master.State<>dsBrowse then
     Master.Post;
end;

procedure TMemorialFrm.grdDetailEnter(Sender: TObject);
begin
  if Master.State<>dsBrowse then
     Master.Post;
...
procedure TMemorialFrm.MasterBeforePost(DataSet: TDataSet);
begin
...
procedure TMemorialFrm.MasterNewRecord(DataSet: TDataSet);
begin
    DM.vSysDate.Close;
    DM.vSysDate.Open;
...
procedure TMemorialFrm.DetailNewRecord(DataSet: TDataSet);
begin
...
procedure TMemorialFrm.DetailBeforePost(DataSet: TDataSet);
begin
...
procedure TMemorialFrm.actCancelExecute(Sender: TObject);
begin
  try
    Detail.Cancel;
    Master.Cancel;
...
procedure TMemorialFrm.btnPrintClick(Sender: TObject);
var msg: string;
   i, row_count: Integer;
begin
...
procedure TMemorialFrm.MasterBeforeOpen(DataSet: TDataSet);
begin
  Master.Params.ParamByName('id_jurnal').Value:= qBrowseid_jurnal.AsLargeInt;
end;

procedure TMemorialFrm.MasterBeforeDelete(DataSet: TDataSet);
var msg: string;
begin
  if Master.RecordCount=0 then
     Exit;
...
procedure TMemorialFrm.MasterBeforeEdit(DataSet: TDataSet);
var msg: string;
begin
  if Master.RecordCount=0 then
    exit;
...
procedure TMemorialFrm.DetailAfterOpen(DataSet: TDataSet);
begin
  CloneDetail;
end;

procedure TMemorialFrm.DetailAfterPost(DataSet: TDataSet);
begin
  CloneDetail;
end;

procedure TMemorialFrm.grddbtvMasterCellDblClick(
...
procedure TMemorialFrm.pgTransactionPageChanging(Sender: TObject;
  NewPage: TcxTabSheet; var AllowChange: Boolean);
begin
   AllowChange:=(DBMode=dmBrowse) or (DBMode=dmNone);
end;

procedure TMemorialFrm.pgTransactionChange(Sender: TObject);
begin
...
procedure TMemorialFrm.EditKeyPress(Sender: TObject; var Key: Char);
begin
    if Key=#13 then
      SelectNext(ActiveControl, True, True);
end;

procedure TMemorialFrm.MemRemarksKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TMemorialFrm.EDT_REPOLookKodeRekeningPropertiesCloseUp(
  Sender: TObject);
begin
   Detailid_rek_gl.AsString:= L_ID_REK_GLid_rek_gl.AsString;
end;

procedure TMemorialFrm.EDT_REPOLookKodeRekeningPropertiesInitPopup(
  Sender: TObject);
begin
    try
      L_ID_REK_GL.Close;
...
procedure TMemorialFrm.grdDetailDBBTVid_rek_glGetPropertiesForEdit(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
begin
...
procedure TMemorialFrm.dtpStartCloseUp(Sender: TObject);
var dt: TDateTime;
    y,m,d: Word;
begin
...
procedure TMemorialFrm.dtpEndCloseUp(Sender: TObject);
var dt: TDateTime;
    y,m,d: Word;
begin
...
procedure TMemorialFrm.qBrowseBeforeOpen(DataSet: TDataSet);
begin
...
procedure TMemorialFrm.btnOKClick(Sender: TObject);
begin
   try
     qBrowse.Close;
     qBrowse.Open;
...
procedure TMemorialFrm.tsDetailShow(Sender: TObject);
begin
  try
    Master.Close;
    Master.Open;
...
procedure TMemorialFrm.grdDetailDBBTVid_arusGetPropertiesForEdit(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
begin
  if Detail.State in [dsInsert,dsedit] then
...
procedure TMemorialFrm.grdDetailDBBTVid_rekananGetPropertiesForEdit(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
begin
  if Detail.State in [dsInsert,dsedit] then
...
procedure TMemorialFrm.grdDetailDBBTVno_reffGetPropertiesForEdit(
  Sender: TcxCustomGridTableItem; ARecord: TcxCustomGridRecord;
  var AProperties: TcxCustomEditProperties);
begin
  if Detail.State in [dsInsert,dsedit] then
...
procedure TMemorialFrm.edtJenisPropertiesCloseUp(Sender: TObject);
begin
   if Master.State=dsBrowse then
      Master.Edit;
...
procedure TMemorialFrm.edtCustNoPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
