object KasKeluarFrm: TKasKeluarFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini berisi daftar Kas Keluar, Khusus untuk hutang jika dipa' +
        'nggil no reff  tampil sejarah hutang tsb. Jumlah, yang telah dib' +
        'ayar(pembayaran) dan sisa. Bila tidak berkaitan dengan hutang ko' +
        'songi saja no reff-nya.'
      Color = clWhite
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object gbRekanan: TcxGroupBox
          ...
          object edtJenis: TcxDBLookupComboBox
            ...
            Properties.ListSource = dsJenisRekanan
          ...
          object edtCustNo: TcxDBButtonEdit
            ...
            Properties.OnButtonClick = edtCustNoPropertiesButtonClick
            Style.Font.Charset = ANSI_CHARSET
            Style.Font.Color = clWindowText
            Style.Font.Height = -11
            Style.Font.Name = 'Arial'
        ...
        object edtRekGL: TcxDBLookupComboBox
          ...
          Properties.ListSource = dsL_ID_REK_KAS
          Style.Edges = []
          TabOrder = 3
      ...
      object grdDetail: TcxGrid
        ...
        object grdDetailDBBTV: TcxGridDBBandedTableView
          ...
          object grdDetailDBBTVno_bukti: TcxGridDBBandedColumn
            Caption = 'NO. FAKTUR'
            DataBinding.FieldName = 'no_bukti'
            OnGetPropertiesForEdit = grdDetailDBBTVno_buktiGetPropertiesForEdit
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Filtering = False
            Options.FilteringFilteredItemsList = False
          ...
          object grdDetailDBBTVColumn1: TcxGridDBBandedColumn
            Caption = 'POTONGAN'
  ...
  object Master: TZQuery
    ...
    object Masteremployee: TStringField
      FieldName = 'employee'
      Size = 50
    end
    ...
    object Masterlprepared_name: TStringField
      FieldKind = fkLookup
      FieldName = 'lprepared_name'
    ...
    object Masterlreviewed_name_1: TStringField
      FieldKind = fkLookup
      FieldName = 'lreviewed_name_1'
      LookupDataSet = DM.L_User
      LookupKeyFields = 'vuser'
      LookupResultField = 'full_name'
    ...
    object Masterlapproved_name_1: TStringField
      FieldKind = fkLookup
      FieldName = 'lapproved_name_1'
      LookupDataSet = DM.L_User
      LookupKeyFields = 'vuser'
      LookupResultField = 'full_name'
    ...
    object Masterlcust_addr: TStringField
      FieldKind = fkLookup
      FieldName = 'lcust_addr'
    ...
    object Masterlcust_name: TStringField
      FieldKind = fkLookup
      FieldName = 'lcust_name'
      LookupDataSet = DM.L_Rekanan
      LookupKeyFields = 'kd_rekanan'
  ...
  object Detail: TZQuery
    ...
    object Detailpotongan: TFloatField
      FieldName = 'potongan'
      Required = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  ...
  object qryGet_CD_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select accfin.fn_gen_payment_number(:pid_trans,:ptgl) as cd_numb' +
        'er')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qryGet_CD_Numbercd_number: TStringField
      FieldName = 'cd_number'
      ReadOnly = True
      Size = 255
    end
  ...
  object MemDetail: TkbmMemTable
    ...
    object MemDetailpotongan: TFloatField
      FieldName = 'potongan'
    end
  end
  ...
  object L_Nota: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.no_doc, a.dt_doc, a.id_curr, a.kurs, a.remarks, a.no_bu' +
        'kti, a.kd_rekanan, a.dt_due, '
      ...
      'left join transaksi.nota c on c.no_nota=a.no_doc'
      
        'WHERE a.kd_rekanan=:pid_supplier and c.isget_pay='#39'0'#39' /*and a.tot' +
        'al_in>(select sum(dibayar) from accfin.payment_detail where no_b' +
        'ukti=a.no_bukti)*/'
      
        'group by a.no_doc, a.dt_doc, a.id_curr, a.kurs, a.remarks, a.no_' +
    ...
    object L_Notano_doc: TStringField
      FieldName = 'no_doc'
      Size = 120
    end
    object L_Notadt_doc: TDateTimeField
      FieldName = 'dt_doc'
    end
    object L_Notaid_curr: TStringField
      FieldName = 'id_curr'
      Size = 12
    end
    object L_Notakurs: TFloatField
      FieldName = 'kurs'
    end
    ...
    object L_Notadt_due: TDateTimeField
      FieldName = 'dt_due'
    end
    object L_Notatotal_in: TFloatField
      FieldName = 'total_in'
    end
    object L_Notatotal_idr: TFloatField
      FieldName = 'total_idr'
    end
    ...
    object L_Notapembayaran_idr: TFloatField
    ...
    object L_Notasisa_idr: TFloatField
      FieldName = 'sisa_idr'
    end
    ...
    object Page1: TfrxReportPage
      ...
      object HeaderPRDetail: TfrxHeader
        ...
        object Memo17: TfrxMemoView
          Left = 487.929500000000000000
          Top = 0.338590000000010600
          Width = 227.385900000000000000
          Height = 37.795300000000000000
          DisplayFormat.DecimalSeparator = '.'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object MasterDataPRDetail: TfrxMasterData
        ...
        object Memo18: TfrxMemoView
          Left = 489.596166670000000000
          Width = 226.719233330000000000
          Height = 18.897650000000000000
          StretchMode = smMaxHeight
          DataSet = frxDBDetail
          DataSetName = 'frxDBDetail'
  ...
  object L_ID_REK_KAS: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'SELECT id_rek_gl, descriptions '
      'FROM master.cash_bank_acc '
      'WHERE jenis='#39'KAS'#39' AND  isdetail='#39'1'#39)
    Params = <>
    Left = 186
    Top = 45
    object L_ID_REK_KASid_rek_gl: TStringField
      FieldName = 'id_rek_gl'
      Size = 30
    end
    object L_ID_REK_KASdescriptions: TStringField
      FieldName = 'descriptions'
      Size = 255
    end
  end
  object dsL_ID_REK_KAS: TDataSource
    DataSet = L_ID_REK_KAS
    Left = 186
    Top = 75
  end
  ...
  object ER: TcxEditRepository
    ...
    object ER_LCB_REFF: TcxEditRepositoryLookupComboBoxItem
      ...
      Properties.DropDownSizeable = True
      Properties.GridMode = True
      Properties.KeyFieldNames = 'no_doc'
      Properties.ListColumns = <
        item
          Caption = 'No. Invoice'
    ...
    object ER_LCB_NO_FAKTUR: TcxEditRepositoryLookupComboBoxItem
      Properties.AutoSelect = False
      Properties.DropDownAutoSize = True
      Properties.DropDownSizeable = True
      Properties.GridMode = True
      ...
      Properties.ListSource = dsL_Nota
      Properties.PostPopupValueOnTab = True
      Properties.OnCloseUp = ER_LCB_NO_FAKTURPropertiesCloseUp
    end
  end
  ...
  object qryRekanan: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      'WHERE jenis=:pjenis and is_aktif='#39'1'#39
      'ORDER BY kd_rekanan')
    Params = <
      item
        DataType = ftUnknown
