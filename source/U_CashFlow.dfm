object CashFlowFrm: TCashFlowFrm
  ...
  Width = 848
  Height = 470
  Caption = 'Master Rekening Arus Kas'
  Color = clBtnFace
  ...
  object dbtlDivisi: TcxDBTreeList
    ...
    object dbtlDivisiketerangan: TcxDBTreeListColumn
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      Height = 42
      AutoSize = False
      Caption = 'Form ini berisi master data kode rekening arus kas'
      Color = clWhite
  ...
  object Master: TZQuery
    ...
    object Masterbudget: TFloatField
      FieldName = 'budget'
      Required = True
    end
