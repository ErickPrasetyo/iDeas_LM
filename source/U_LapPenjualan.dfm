object LapPenjualanFrm: TLapPenjualanFrm
  ...
  object pgcMaster: TcxPageControl
    ...
    object tsItemPromo: TcxTabSheet
      Caption = 'Rekap Item Promo Barang'
      ImageIndex = 1
    ...
    object tsPromoUang: TcxTabSheet
      Caption = 'Rekap Item Promo Uang'
      ImageIndex = 4
      OnShow = tsPromoUangShow
      object grdPromoUang: TcxGrid
        Left = 0
        Top = 0
        Width = 972
        Height = 444
        ...
        ParentFont = False
        TabOrder = 0
        object grddbtvPromoUang: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.DataSource = dsPromoUang
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <
            item
              Format = ',0'
            ...
            item
              ...
              Kind = skSum
              FieldName = 'disc_rp'
              Column = grddbtvPromoUangColumn1
            end
            item
              Kind = skCount
          ...
          object grddbtvPromoUangColumn1: TcxGridDBColumn
            Caption = 'Diskon'
            DataBinding.FieldName = 'disc_rp'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
        ...
        object grdlvlPromoUang: TcxGridLevel
          GridView = grddbtvPromoUang
        end
      end
    end
    object tsDiscMember: TcxTabSheet
      Caption = 'Rekap Diskon Member'
      ImageIndex = 5
      OnShow = tsDiscMemberShow
      object grdDiscMember: TcxGrid
        Left = 0
        Top = 0
        Width = 972
        Height = 256
        ...
        ParentFont = False
        TabOrder = 0
        object grddbtvDiscMember: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.DataSource = dsRepDiscMember
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <
            item
              Format = ',0'
            ...
            item
              Format = ',#'
              Kind = skSum
              Column = grddbtvDiscMemberColumn5
            end
            item
              Format = ',#'
              Kind = skSum
              Column = grddbtvDiscMemberColumn6
            end
            item
              Format = ',#'
              Kind = skSum
              Column = grddbtvDiscMemberColumn7
            end
            item
              Format = ',#'
              Kind = skSum
              Column = grddbtvDiscMemberColumn8
            end
            item
              Kind = skCount
              Column = grddbtvDiscMemberColumn1
            end>
          DataController.Summary.SummaryGroups = <>
          OptionsBehavior.GoToNextCellOnEnter = True
          OptionsData.CancelOnExit = False
          ...
          Styles.Header = cxStyle1
          Styles.Indicator = cxStyle4
          object grddbtvDiscMemberColumn1: TcxGridDBColumn
          ...
          object grddbtvDiscMemberColumn2: TcxGridDBColumn
            Caption = 'Nama'
            DataBinding.FieldName = 'nama_rekanan'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grddbtvDiscMemberColumn3: TcxGridDBColumn
            Caption = 'Alamat'
          ...
          object grddbtvDiscMemberColumn4: TcxGridDBColumn
            Caption = 'Telephone'
          ...
          object grddbtvDiscMemberColumn5: TcxGridDBColumn
            Caption = 'Sub Total'
            DataBinding.FieldName = 'sub_total'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grddbtvDiscMemberColumn6: TcxGridDBColumn
            Caption = 'Diskon Item'
            DataBinding.FieldName = 'disc_item'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 120
          end
          object grddbtvDiscMemberColumn7: TcxGridDBColumn
          ...
          object grddbtvDiscMemberColumn8: TcxGridDBColumn
            Caption = 'Total'
            DataBinding.FieldName = 'total'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
        ...
        object grdlvlDiscMember: TcxGridLevel
          GridView = grddbtvDiscMember
        end
      end
      ...
      object grdDiscMemberDetail: TcxGrid
        Left = 0
        Top = 296
        Width = 972
        Height = 148
        ...
        ParentFont = False
        TabOrder = 2
        object grddbtvDiscMemberDetail: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          DataController.DataSource = dsDiscMemberDetail
          DataController.Summary.DefaultGroupSummaryItems = <>
          DataController.Summary.FooterSummaryItems = <
            item
              Format = ',0'
        ...
        object grdlvlDiscMemberDetail: TcxGridLevel
          GridView = grddbtvDiscMemberDetail
        end
      end
    end
  end
  ...
  object PromoUang: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select a.no_nota, a.dt_nota, nd.disc_rp, a.shift, a.usr_upd,'
      
        'nd.kd_item, c.nama_item, nd.hrg, nd.qty_biji, c.satuan_jual, (nd' +
        '.hrg*nd.qty_biji)-nd.disc_rp as sub_total, c.hrg_beli, (nd.hrg-c' +
        '.hrg_beli)*nd.qty_biji as margin_penjualan'
      'from transaksi.nota_detail nd'
      'left join transaksi.nota a on a.id_nota=nd.id_nota'
      'left join master.item c on c.kd_item=nd.kd_item'
      
        'where id_trans='#39'201'#39' and a.ispost='#39'1'#39' and a.iscancel='#39'0'#39' and a.i' +
        'sdelete='#39'0'#39' and nd.disc_rp > 0'
    ...
    object PromoUangno_nota: TStringField
      FieldName = 'no_nota'
      Size = 120
    end
    object PromoUangdt_nota: TDateTimeField
      FieldName = 'dt_nota'
      Required = True
    end
    object PromoUangdisc_rp: TFloatField
      FieldName = 'disc_rp'
      Required = True
    end
    object PromoUangshift: TIntegerField
      FieldName = 'shift'
    end
    object PromoUangusr_upd: TStringField
      FieldName = 'usr_upd'
      Required = True
      Size = 120
    end
    object PromoUangkd_item: TStringField
      FieldName = 'kd_item'
      Required = True
      Size = 200
    end
    object PromoUangnama_item: TStringField
      FieldName = 'nama_item'
      Size = 1020
    end
    object PromoUanghrg: TFloatField
      FieldName = 'hrg'
      Required = True
    end
    object PromoUangqty_biji: TFloatField
      FieldName = 'qty_biji'
      Required = True
    end
    object PromoUangsatuan_jual: TStringField
      FieldName = 'satuan_jual'
      Size = 80
    end
    object PromoUangsub_total: TFloatField
      FieldName = 'sub_total'
      ReadOnly = True
    end
    object PromoUanghrg_beli: TFloatField
      FieldName = 'hrg_beli'
      Required = True
    end
    object PromoUangmargin_penjualan: TFloatField
      FieldName = 'margin_penjualan'
      ReadOnly = True
    end
  end
  object dsPromoUang: TDataSource
    DataSet = PromoUang
    Left = 520
    Top = 256
  end
  object frxDBPromoUang: TfrxDBDataset
    UserName = 'frxDBPromoUang'
    CloseDataSource = False
    FieldAliases.Strings = (
      'no_nota=no_nota'
      'dt_nota=dt_nota'
  ...
  object frxReport2: TfrxReport
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBPromoUang
        DataSetName = 'frxDBPromoUang'
      end>
    Variables = <>
    Style = <>
    object Data: TfrxDataPage
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo32: TfrxMemoView
          ...
          GapX = 4.000000000000000000
          Memo.UTF8 = (
            '[frxDBPromoUang."no_nota"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo10: TfrxMemoView
          Left = 427.559370000000000000
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo20: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBPromoUang."sub_total">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo22: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBPromoUang."disc_rp">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object RepDiscMember: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select a.kd_rekanan, a.nama_rekanan, a.alamat||'#39' '#39'||a.kota as al' +
        'amat, a.telephone,'
      'sum(b.sub_total) as sub_total,'
      'sum(b.disc_rp) as disc_item,'
      'sum(b.disc_member) as disc_member,'
      'sum(b.total) as total'
      'from master.mrekanan a'
      'left join transaksi.nota b on b.kd_rekanan = a.kd_rekanan'
      'where b.dt_nota between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39')'
      
        #9#9#9#9'and to_timestamp(:ptgl1,'#39'dd/mm/yyyy'#39') + interval '#39'23 hour 59' +
        ' minute 59 sec'#39' and'
      
        'b.ispost = '#39'1'#39' and b.iscancel = '#39'0'#39' and b.isdelete = '#39'0'#39' and b.i' +
        'd_trans = '#39'201'#39' and'
      'b.kd_rekanan <> '#39'CASH'#39
      
        'group by a.kd_rekanan, a.nama_rekanan, a.alamat, a.kota, a.telep' +
        'hone'
    ...
    object RepDiscMemberkd_rekanan: TStringField
      FieldName = 'kd_rekanan'
      Required = True
      Size = 80
    end
    object RepDiscMembernama_rekanan: TStringField
      FieldName = 'nama_rekanan'
      Required = True
      Size = 1020
    end
    object RepDiscMembertelephone: TStringField
      FieldName = 'telephone'
      Size = 400
    end
    object RepDiscMembersub_total: TFloatField
      FieldName = 'sub_total'
      ReadOnly = True
      DisplayFormat = ',#'
    end
    object RepDiscMemberdisc_item: TFloatField
      FieldName = 'disc_item'
      ReadOnly = True
      DisplayFormat = ',#'
    end
    object RepDiscMemberdisc_member: TFloatField
      FieldName = 'disc_member'
      ReadOnly = True
      DisplayFormat = ',#'
    end
    object RepDiscMembertotal: TFloatField
      FieldName = 'total'
      ReadOnly = True
      DisplayFormat = ',#'
    end
    object RepDiscMemberalamat: TMemoField
      FieldName = 'alamat'
      ReadOnly = True
      BlobType = ftMemo
    end
  end
  object frxDBRepDiscMember: TfrxDBDataset
    UserName = 'frxDBRepDiscMember'
    CloseDataSource = False
    FieldAliases.Strings = (
      'kd_rekanan=kd_rekanan'
      'nama_rekanan=nama_rekanan'
      ...
      'total=total'
      'alamat=alamat')
    DataSet = RepDiscMember
    BCDToCurrency = False
    Left = 627
    Top = 230
  end
  object dsRepDiscMember: TDataSource
    DataSet = RepDiscMember
    Left = 603
    Top = 257
  end
  object frxRepDiscMember: TfrxReport
    Version = '5.2.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbExport, pbZoom, pbPageSetup, pbNavigator]
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBRepDiscMember
        DataSetName = 'frxDBRepDiscMember'
      end>
    Variables = <>
    Style = <>
    object Data: TfrxDataPage
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo31: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBRepDiscMember."nama_rekanan"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo32: TfrxMemoView
        ...
        object Memo11: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[frxDBRepDiscMember."disc_member"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo20: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBRepDiscMember."total">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo22: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBRepDiscMember."sub_total">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo18: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBRepDiscMember."disc_item">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo23: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBRepDiscMember."disc_member">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object DiscMemberDetail: TZQuery
    Connection = DM.conn
    BeforeOpen = DiscMemberDetailBeforeOpen
    SQL.Strings = (
      
        'select a.no_nota, a.dt_nota, a.kd_rekanan, a.sub_total, a.disc_r' +
        'p as disc_item, a.disc_member, a.total,'
      'a.usr_ins, a.ispost, b.nama_rekanan'
      'from transaksi.nota a'
      'left join master.mrekanan b on b.kd_rekanan = a.kd_rekanan'
      
        'where a.ispost = '#39'1'#39' and iscancel = '#39'0'#39' and a.isdelete = '#39'0'#39' and' +
        ' a.id_trans = '#39'201'#39
      'and a.dt_nota between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39')'
      
        #9#9#9#9'and to_timestamp(:ptgl1,'#39'dd/mm/yyyy'#39') + interval '#39'23 hour 59' +
        ' minute 59 sec'#39
      'order by a.dt_nota asc')
    Params = <
      item
        DataType = ftUnknown
        Name = 'ptgl0'
    ...
    DataSource = dsRepDiscMember
    MasterFields = 'kd_rekanan'
    MasterSource = dsRepDiscMember
    LinkedFields = 'kd_rekanan'
    Left = 603
    Top = 289
    ParamData = <
      item
    ...
    object DiscMemberDetailno_nota: TStringField
      FieldName = 'no_nota'
      Size = 120
    end
    object DiscMemberDetaildt_nota: TDateTimeField
      FieldName = 'dt_nota'
      Required = True
    end
    object DiscMemberDetailkd_rekanan: TStringField
      FieldName = 'kd_rekanan'
      Size = 400
    end
    object DiscMemberDetailsub_total: TFloatField
      FieldName = 'sub_total'
      Required = True
      DisplayFormat = ',0'
    end
    object DiscMemberDetaildisc_item: TFloatField
      FieldName = 'disc_item'
      Required = True
      DisplayFormat = ',0'
    end
    object DiscMemberDetaildisc_member: TFloatField
      FieldName = 'disc_member'
      Required = True
      DisplayFormat = ',0'
    end
    object DiscMemberDetailtotal: TFloatField
      FieldName = 'total'
      Required = True
      DisplayFormat = ',0'
    end
    object DiscMemberDetailusr_ins: TStringField
      FieldName = 'usr_ins'
      Required = True
      Size = 120
    end
    object DiscMemberDetailispost: TStringField
      FieldName = 'ispost'
      Required = True
      Size = 4
    end
    object DiscMemberDetailnama_rekanan: TStringField
      FieldName = 'nama_rekanan'
      Required = True
      Size = 1020
    end
  end
  object dsDiscMemberDetail: TDataSource
    DataSet = DiscMemberDetail
    Left = 607
    Top = 321
  end
  object PopUp: TAdvPopupMenu
    ...
    object CetakRekap: TMenuItem
      ...
      ImageIndex = 0
      OnClick = CetakRekapClick
    end
    object CetakDetail: TMenuItem
      Caption = 'Cetak Detal'
      SubMenuImages = DM.ImageList1
      ImageIndex = 8
      OnClick = CetakDetailClick
    end
  end
  object frxDBDiscMemberDetail: TfrxDBDataset
    UserName = 'frxDBDiscMemberDetail'
    CloseDataSource = False
    FieldAliases.Strings = (
      'no_nota=no_nota'
      'dt_nota=dt_nota'
  ...
  object frxDiscMemberDetail: TfrxReport
    Version = '5.2.3'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbExport, pbZoom, pbPageSetup, pbNavigator]
    ...
    Datasets = <
      item
        DataSet = frxDBDiscMemberDetail
        DataSetName = 'frxDBDiscMemberDetail'
      end
      item
        DataSet = frxDBInfo
        DataSetName = 'frxDBInfo'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo21: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[frxDBDiscMemberDetail."sub_total"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo30: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBDiscMemberDetail."disc_item"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo31: TfrxMemoView
        ...
        object Memo10: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[frxDBDiscMemberDetail."disc_member"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo19: TfrxMemoView
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo12: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBDiscMemberDetail."disc_item">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo13: TfrxMemoView
        ...
        object Memo11: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBDiscMemberDetail."disc_member">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo20: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBDiscMemberDetail."total">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo7: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBDiscMemberDetail."sub_total">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 699.213050000000000000
        Condition = 'frxDBDiscMemberDetail."kd_rekanan"'
        object Memo3: TfrxMemoView
        ...
        object Memo17: TfrxMemoView
          ...
          Frame.TopLine.Width = 2.000000000000000000
          Memo.UTF8 = (
            '[frxDBDiscMemberDetail."kd_rekanan"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo18: TfrxMemoView
        ...
        object Memo35: TfrxMemoView
          ...
          Frame.TopLine.Width = 2.000000000000000000
          Memo.UTF8 = (
            '[frxDBDiscMemberDetail."nama_rekanan"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
