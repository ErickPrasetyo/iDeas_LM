object JenisAsetFrm: TJenisAsetFrm
  Left = 188
  Top = 144
  Width = 1098
  Height = 485
  ...
  object dbtlDivision: TcxDBTreeList
    ...
    DataController.KeyField = 'kd_jenis'
    ...
    object dbtlDivisionid_rek_gl: TcxDBTreeListColumn
      ...
      Caption.Text = 'Kode'
      DataBinding.FieldName = 'kd_jenis'
    ...
    object dbtlDivisionumur_thn: TcxDBTreeListColumn
      PropertiesClassName = 'TcxLabelProperties'
      Properties.Alignment.Horz = taCenter
      Properties.Alignment.Vert = taVCenter
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
      Caption.Text = 'Umur [Tahun]'
      DataBinding.FieldName = 'umur_thn'
      Width = 94
      Position.ColIndex = 4
      Position.RowIndex = 0
      Position.BandIndex = 0
    end
    object dbtlDivisionpsn_susut: TcxDBTreeListColumn
      PropertiesClassName = 'TcxLabelProperties'
      Properties.Alignment.Horz = taCenter
      Properties.Alignment.Vert = taVCenter
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
      Caption.Text = 'Penyusutan [%]'
      DataBinding.FieldName = 'psn_susut'
      Width = 106
      Position.ColIndex = 4
      Position.RowIndex = 0
      Position.BandIndex = 0
    end
    object dbtlDivisionid_rek_aktiva: TcxDBTreeListColumn
      PropertiesClassName = 'TcxLabelProperties'
      Properties.Alignment.Horz = taCenter
      Properties.Alignment.Vert = taVCenter
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
      Caption.Text = 'Rek. Aktiva Tetap'
      DataBinding.FieldName = 'id_rek_aktiva'
      Width = 117
      Position.ColIndex = 4
      Position.RowIndex = 0
      Position.BandIndex = 0
    end
    object dbtlDivisionid_rek_akum: TcxDBTreeListColumn
      PropertiesClassName = 'TcxLabelProperties'
      Properties.Alignment.Horz = taCenter
      Properties.Alignment.Vert = taVCenter
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
      Caption.Text = 'Rek. Akum. Penyusutan'
      DataBinding.FieldName = 'id_rek_akum'
      Width = 155
      Position.ColIndex = 5
      Position.RowIndex = 0
      Position.BandIndex = 0
    end
    object dbtlDivisionid_rek_biaya: TcxDBTreeListColumn
      PropertiesClassName = 'TcxLabelProperties'
      Properties.Alignment.Horz = taCenter
      Properties.Alignment.Vert = taVCenter
      Caption.AlignHorz = taCenter
      Caption.AlignVert = vaCenter
      Caption.Text = 'Rek. Beban Penyusutan'
      DataBinding.FieldName = 'id_rek_biaya'
      Width = 155
      Position.ColIndex = 8
      Position.RowIndex = 0
      Position.BandIndex = 0
  ...
  object pnlDataBackground: TPanel
    ...
    object pnlData: TSCPanel
      ...
      object edtKode: TcxDBTextEdit
        Left = 106
        Top = 13
        DataBinding.DataField = 'kd_jenis'
      ...
      object edtKode_Parent: TcxDBTextEdit
        Left = 106
        Top = 40
        DataBinding.DataField = 'kd_parent'
        DataBinding.DataSource = dsMaster
        Style.Shadow = False
        StyleFocused.BorderStyle = ebsThick
        StyleHot.BorderStyle = ebsThick
      ...
      object edtUmur: TcxDBTextEdit
        Left = 105
        Top = 96
        DataBinding.DataField = 'umur_thn'
        DataBinding.DataSource = dsMaster
        Style.Shadow = False
        StyleFocused.BorderStyle = ebsThick
        StyleHot.BorderStyle = ebsThick
      ...
      object edtRekPsnSusut: TcxDBTextEdit
        Left = 339
        Top = 96
        DataBinding.DataField = 'psn_susut'
        DataBinding.DataSource = dsMaster
        Style.Shadow = False
        StyleFocused.BorderStyle = ebsThick
        StyleHot.BorderStyle = ebsThick
      ...
      object edtRekAkiva: TcxDBButtonEdit
        Left = 106
        Top = 123
        DataBinding.DataField = 'id_rek_aktiva'
        DataBinding.DataSource = dsMaster
        Properties.Buttons = <
          item
            Default = True
        ...
        Properties.OnButtonClick = edtRekAkivaPropertiesButtonClick
        Style.Shadow = False
        TabOrder = 7
        Width = 121
      end
      object edtRekAkumSusut: TcxDBButtonEdit
        Left = 339
        Top = 123
        DataBinding.DataField = 'id_rek_akum'
        DataBinding.DataSource = dsMaster
        Properties.Buttons = <
          item
            Default = True
        ...
        Properties.OnButtonClick = edtRekAkumSusutPropertiesButtonClick
        Style.Shadow = False
        TabOrder = 8
        Width = 137
      end
      object edtRekBebanSusut: TcxDBButtonEdit
        Left = 106
        Top = 150
        DataBinding.DataField = 'id_rek_biaya'
        DataBinding.DataSource = dsMaster
        Properties.Buttons = <
          item
            Default = True
        ...
        Properties.OnButtonClick = edtRekBebanSusutPropertiesButtonClick
        Style.Shadow = False
        TabOrder = 9
        Width = 121
      end
  ...
  object Master: TZQuery
    ...
    object Masterid_rek_aktiva: TStringField
      FieldName = 'id_rek_aktiva'
      Size = 30
    end
    object Masterid_rek_akum: TStringField
    ...
    object Masterid_rek_biaya: TStringField
