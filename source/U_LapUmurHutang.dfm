object LapUmurHutangFrm: TLapUmurHutangFrm
  Left = 309
  Top = 190
  Width = 1291
  Height = 749
    ...
    object grd_DBTV_Item: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Format = '0.0,0'
          Kind = skSum
          Column = grd_DBTV_ItemColumn1
        end
        item
          Format = '0.0,0'
          Kind = skSum
          Column = grd_DBTV_ItemColumn2
        end>
      DataController.Summary.SummaryGroups = <>
      ...
      object grd_DBTV_Itemsisa: TcxGridDBColumn
        Caption = 'Sisa Hutang'
        DataBinding.FieldName = 'sisa_pembayaran'
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Editing = False
        Width = 124
  ...
  object Master: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'select *'
      'from transaksi.fn_rep_ap_list_new_age(:ptgl)')
    Params = <
      item
        DataType = ftString
        Name = 'ptgl'
    ...
    object Masternama_outlet: TStringField
    ...
    object Mastersisa_pembayaran: TFloatField
      FieldName = 'sisa_pembayaran'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
  ...
  object frxDBMaster0: TfrxDBDataset
    UserName = 'frxDBMaster0'
  ...
  object frxARAging: TfrxReport
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBMaster0
        DataSetName = 'frxDBMaster0'
      end>
    Variables = <>
    Style = <>
  ...
  object memMaster: TkbmMemTable
    ...
    object memMasternama_outlet: TStringField
      FieldName = 'nama_outlet'
      ReadOnly = True
      Size = 252
    end
    ...
    object memMasterdt_jth_tempo: TDateTimeField
      FieldName = 'dt_jth_tempo'
      ReadOnly = True
    end
    ...
    object memMasternama_principal: TStringField
      FieldName = 'nama_principal'
      ReadOnly = True
      Size = 252
    end
    object memMasterperiode: TStringField
      FieldName = 'periode'
      ReadOnly = True
      Size = 32
    end
    ...
    object memMastersisa_pembayaran: TFloatField
      FieldName = 'sisa_pembayaran'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object memMastercurrent: TFloatField
      FieldName = 'current'
      ReadOnly = True
    end
    object memMastertiga_puluh: TFloatField
      FieldName = 'tiga_puluh'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object memMasterenam_puluh: TFloatField
      FieldName = 'enam_puluh'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object memMastersembilan_puluh: TFloatField
      FieldName = 'sembilan_puluh'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    object memMasterlebih_sembilan_puluh: TFloatField
      FieldName = 'lebih_sembilan_puluh'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
    ...
    object Page1: TfrxReportPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo40: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBMaster."sisa_pembayaran">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo41: TfrxMemoView
          Top = 7.559060000000000000
          Width = 272.126098980000000000
          Height = 22.677165350000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          ...
          Font.Style = [fsBold]
          Memo.UTF8 = (
            'TOTAL HUTANG < 30 HARI sd. PERIODE INI')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo48: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8 = (
            'TOTAL HUTANG < 60 HARI sd. PERIODE INI')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo52: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8 = (
            'TOTAL HUTANG < 90 HARI sd. PERIODE INI')
          ParentFont = False
          VAlign = vaCenter
        end
