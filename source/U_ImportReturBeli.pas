...
type
  TImportReturBeliFrm = class(TForm)
    pnlTop: TSCPanel;
    lblHeader: TLabel;
...
var
  ImportReturBeliFrm: TImportReturBeliFrm;
...
function TImportReturBeliFrm.GetMonthNum(vMonth:String):integer;
begin
   Result:= 0;
...
function TImportReturBeliFrm.CekString(vString:string):Boolean ;
begin
   Result:= True;
...
procedure TImportReturBeliFrm.setButton(state:string);
begin
...
procedure TImportReturBeliFrm.ConnectToExcel;
...
procedure TImportReturBeliFrm.FetchData;
begin
...
procedure TImportReturBeliFrm.edtFileExcelPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
begin
...
procedure TImportReturBeliFrm.FormCreate(Sender: TObject);
begin
...
procedure TImportReturBeliFrm.btnFetchClick(Sender: TObject);
begin
...
procedure TImportReturBeliFrm.ImportMaster;
var
    dtF : TDateTime;
    iq, i, cnt: Integer;
    isNewNota : boolean;
...
procedure TImportReturBeliFrm.ImportDetail;
var
    iq, i, cnt, p: Integer;
    isPCCode : boolean;
...
procedure TImportReturBeliFrm.ImportError;
var s : String;
begin
...
procedure TImportReturBeliFrm.GoToTheRealTable;
var s : String;
begin
  try
...
procedure TImportReturBeliFrm.FormShow(Sender: TObject);
begin
  LblStatus.Caption:= '';
  lblHeader.Caption:= 'Import Data Retur Pembelian';
...
procedure TImportReturBeliFrm.tabImportErrorShow(Sender: TObject);
begin
   try
     QTableError.Close;
     QTableError.Open;
...
procedure TImportReturBeliFrm.btnImportClick(Sender: TObject);
begin
...
procedure TImportReturBeliFrm.edtSupplierPropertiesButtonClick(
...
procedure TImportReturBeliFrm.tabImportDataShow(Sender: TObject);
begin
  lblHeader.Caption:= 'Import Data Faktur Pembelian';
end;

procedure TImportReturBeliFrm.btnInsertErrorClick(Sender: TObject);
begin
...
function TImportReturBeliFrm.FixedErrorData:Boolean;
var s : String;
   i, cnt: Integer;
begin
     Result:= False;
