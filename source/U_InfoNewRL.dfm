object InfoNewRLFrm: TInfoNewRLFrm
  Left = 331
  Top = 103
  Width = 894
  Height = 628
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'SELECT * '
      'FROM accfin.fn_get_lari(:ptgl0, :ptgl1)'
      'ORDER BY id_rek_rl')
    Params = <
      item
        DataType = ftString
    ...
    object Masterid_rek_rl: TStringField
      FieldName = 'id_rek_rl'
      ReadOnly = True
      Size = 255
    end
    ...
    object Masterperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
    object Masterperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
      DisplayFormat = '#,##0.00;(#,##0.00)'
    end
  ...
  object frxDB_PENDAPATAN: TfrxDBDataset
    UserName = 'frxDB_PENDAPATAN'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_rek_rl=id_rek_rl'
      'diskripsi=diskripsi'
  ...
  object qPENDAPATAN: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'SELECT * '
      'FROM accfin.fn_get_lari(:ptgl0, :ptgl1)'
      'WHERE substr(id_rek_rl,1,1)='#39'L'#39
      'ORDER BY id_rek_rl')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qPENDAPATANid_rek_rl: TStringField
      FieldName = 'id_rek_rl'
      ReadOnly = True
      Size = 255
    end
    object qPENDAPATANdiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    object qPENDAPATANjenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object qPENDAPATANperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
    end
    object qPENDAPATANperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
    end
  end
  ...
  object frxRL: TfrxReport
    ...
    Datasets = <
      item
        DataSet = frxDB_BEBAN
        DataSetName = 'frxDB_BEBAN'
      end
      item
        DataSet = frxDB_PENDAPATAN
        DataSetName = 'frxDB_PENDAPATAN'
      end
      item
        DataSet = frxDBInfo
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 699.213050000000000000
        Condition = 'frxDB_PENDAPATAN."jenis"'
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo14: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDB_PENDAPATAN."periode_ini">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDB_PENDAPATAN."periode_lalu">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object GroupFooter2: TfrxGroupFooter
        ...
        object Memo27: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDB_BEBAN."periode_ini">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo28: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDB_BEBAN."periode_lalu">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo5: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[SUM(<frxDB_PENDAPATAN."periode_ini">,MasterData1)-SUM(<frxDB_BE' +
              'BAN."periode_ini">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo32: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              '[SUM(<frxDB_PENDAPATAN."periode_lalu">,MasterData1)-SUM(<frxDB_B' +
              'EBAN."periode_lalu">,MasterData2)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object qBEBAN: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'SELECT * '
      'FROM accfin.fn_get_lari(:ptgl0, :ptgl1)'
      'WHERE substr(id_rek_rl,1,1)='#39'R'#39
      'ORDER BY id_rek_rl')
    Params = <
      item
        DataType = ftUnknown
    ...
    object qBEBANid_rek_rl: TStringField
      FieldName = 'id_rek_rl'
      ReadOnly = True
      Size = 255
    end
    object qBEBANdiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 255
    end
    ...
    object qBEBANperiode_lalu: TFloatField
      FieldName = 'periode_lalu'
      ReadOnly = True
    end
    object qBEBANperiode_ini: TFloatField
      FieldName = 'periode_ini'
      ReadOnly = True
    end
  end
  object frxDB_BEBAN: TfrxDBDataset
    UserName = 'frxDB_BEBAN'
    CloseDataSource = False
    FieldAliases.Strings = (
      'id_rek_rl=id_rek_rl'
      'diskripsi=diskripsi'
