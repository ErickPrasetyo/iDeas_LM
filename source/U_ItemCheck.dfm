object ItemCheckFrm: TItemCheckFrm
  ...
  object pnlDetailSupplier: TRzPanel
    ...
    object GroupBox1: TGroupBox
      ...
      object RzDBLabel4: TRzDBLabel
        ...
        BlinkIntervalOff = 600
        BlinkIntervalOn = 600
        DataField = 'hrg_jual_grosir_besar'
        DataSource = dsMaster
      end
  ...
  object Panel2: TPanel
    ...
    object lblRunnungText: TLabel
      ...
      AutoSize = False
      Caption = 
        '**TOKO LAMPU MERAH**  Jl. Pao Pasar No. 23 Murtajih - Pamekasan ' +
        '- Madura.        SELAMAT BERBELANJA & TERIMAKASIH ATAS KUNJUNGAN' +
        ' ANDA..'
      Color = clTeal
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
