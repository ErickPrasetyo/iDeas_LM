object LapKasirPerShiftFrm: TLapKasirPerShiftFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini adalah kasir tunai dan non tunai yang merupakan rekap p' +
        'embayaran tunai dan non tunai dari tagihan pasien di Rumah Sakit'
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterid_purchase_receive: TcxGridDBColumn
            Caption = 'Index #'
            DataBinding.FieldName = 'kd_kasir'
          ...
          object grddbtvMasterdt_transaksi: TcxGridDBColumn
          ...
          object grddbtvMastershift: TcxGridDBColumn
            Caption = 'Shift'
          ...
          object grddbtvMastertunai: TcxGridDBColumn
            Caption = 'Total Tunai'
            DataBinding.FieldName = 'total_tunai'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Width = 102
          end
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object cxGroupBox3: TcxGroupBox
          ...
          object edtDateTransaksi: TcxDBDateEdit
            Left = 76
            Top = 13
      ...
      object grdDetail: TcxGrid
        ...
        object grddbtvDetail: TcxGridDBTableView
          ...
          object grddbtvDetailid_rekanan: TcxGridDBColumn
            Caption = 'User/Kasir'
            DataBinding.FieldName = 'nama_kasir'
            PropertiesClassName = 'TcxLabelProperties'
            Properties.Alignment.Horz = taCenter
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'select * '
      'from accfin.kasir'
      'where id_trans=:pid_trans and isdelete='#39'0'#39' and'
      
        'dt_kasir between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and to_timest' +
        'amp(:ptgl1,'#39'dd/mm/yyyy'#39') +  interval '#39'23 hours 59 min'#39
      'order by dt_kasir, shift')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid_trans'
    ...
    object Masterno_kasir: TStringField
      FieldName = 'no_kasir'
      Size = 120
    end
    ...
    object Masterdt_kasir: TDateTimeField
      FieldName = 'dt_kasir'
      Required = True
    end
    ...
    object Masterdt_transaksi: TDateTimeField
  ...
  object Detail: TZQuery
    ...
    SQL.Strings = (
      'select a.*'
      'from accfin.kasir_detail a'
      'where a.id_kasir=:id_kasir'
      'order by urut')
    Params = <
      item
        DataType = ftUnknown
    ...
    object Detailid_kasir: TLargeintField
      FieldName = 'id_kasir'
      Required = True
    end
    ...
    object Detailid_trans: TStringField
      FieldName = 'id_trans'
      Size = 40
    end
    object Detailnama_kasir: TStringField
      FieldName = 'nama_kasir'
      Size = 120
    end
    object Detailnama_customer: TStringField
    ...
    object Detaildisc_member: TFloatField
  ...
  object qryGet_Kasir_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select accfin.fn_gen_kasir_number(:pid_trans)')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid_trans'
    ...
    object qryGet_Kasir_Numberfn_gen_kasir_number: TStringField
  ...
  object MemDetail: TkbmMemTable
    ...
    Left = 691
    Top = 15
    object MemDetailtotal_seluruh: TFloatField
      FieldName = 'total_seluruh'
    end
    object MemDetailjns_pasien: TStringField
      FieldName = 'jns_pasien'
      Size = 100
    end
    ...
    object MemDetailbayar: TStringField
      FieldName = 'bayar'
      Size = 100
    end
    object MemDetailnama_pasien: TStringField
      FieldName = 'nama_pasien'
      Size = 100
    end
    object MemDetailpenjamin: TStringField
      FieldName = 'penjamin'
      Size = 50
    end
    ...
    object MemDetailtotall: TFloatField
      FieldName = 'totall'
      DisplayFormat = ',#,0;(,#,0)'
    end
    object MemDetailtotal_tunai: TFloatField
      FieldName = 'total_tunai'
      DisplayFormat = ',#,0;(,#,0)'
    end
    object MemDetailtotal_kredit: TFloatField
      FieldName = 'total_kredit'
      DisplayFormat = ',#,0;(,#,0)'
    end
    object MemDetailtunai: TFloatField
      FieldName = 'tunai'
      DisplayFormat = ',#,0;(,#,0)'
    end
    ...
    object MemDetailno_reg: TStringField
      FieldName = 'no_reg'
      Size = 50
    end
    object MemDetailuser: TStringField
      FieldName = 'user'
      Size = 100
    end
    ...
    object MemDetailjenis_nota: TStringField
      FieldName = 'jenis_nota'
      Size = 100
    end
    object MemDetailid_pasien: TStringField
      FieldName = 'id_pasien'
      Size = 255
    end
  end
  object MemMaster: TkbmMemTable
    ...
    Left = 722
    Top = 14
    object MemMasterchecked: TStringField
      FieldName = 'checked'
      Size = 50
    end
    object MemMasterapproved: TStringField
      FieldName = 'approved'
      Size = 50
    end
    object MemMastermade: TStringField
      FieldName = 'made'
      Size = 50
    end
    object MemMasterjudul: TStringField
      FieldName = 'judul'
      Size = 100
    end
    ...
    object MemMasterno_kasir: TStringField
      FieldName = 'no_kasir'
      Size = 50
    end
    object MemMasterdt_kasir: TStringField
      FieldName = 'dt_kasir'
      Size = 50
    end
    ...
    object MemMasterdt_transaksi: TStringField
      FieldName = 'dt_transaksi'
      Size = 100
    end
  end
  ...
  object frxRepMaster2: TfrxReport
    Version = '5.2.3'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBDetail."disc_member">,MasterData1)]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.906000000000000000
        Condition = 'frxDBDetail."cara_bayar"'
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo9: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            'TOTAL PENDAPATAN [frxDBDetail."cara_bayar"]')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object qNota: TZQuery
    ...
    object qNotaid_division: TStringField
    ...
    object qNotadt_jth_tempo: TDateTimeField
      FieldName = 'dt_jth_tempo'
    end
    object qNotadiskripsi: TStringField
      FieldName = 'diskripsi'
      Size = 1020
    end
    object qNotasub_total: TFloatField
      FieldName = 'sub_total'
      Required = True
    end
    object qNotaclaim: TFloatField
      FieldName = 'claim'
      Required = True
    end
    object qNotadisc_rp: TFloatField
      FieldName = 'disc_rp'
      Required = True
    end
    object qNotapromo_uang: TFloatField
      FieldName = 'promo_uang'
      Required = True
    end
    object qNotapromo_barang: TFloatField
      FieldName = 'promo_barang'
      Required = True
    end
    object qNotanet_n_ppn: TFloatField
      FieldName = 'net_n_ppn'
      Required = True
    end
    object qNotaiskirim: TStringField
      FieldName = 'iskirim'
      Required = True
      Size = 4
    end
    object qNotaislunas: TStringField
      FieldName = 'islunas'
      Required = True
      Size = 4
    end
    object qNotaretur: TFloatField
      FieldName = 'retur'
      Required = True
    end
    object qNotaishpp: TStringField
      FieldName = 'ishpp'
      Required = True
      Size = 4
    end
    object qNotadt_lunas: TDateTimeField
      FieldName = 'dt_lunas'
    end
    object qNotadt_kirim: TDateTimeField
      FieldName = 'dt_kirim'
    end
    object qNotaisok: TStringField
      FieldName = 'isok'
      Required = True
      Size = 4
    end
    object qNotadt_posting: TDateTimeField
      FieldName = 'dt_posting'
    end
    object qNotanota_diretur: TStringField
    ...
    object qNotavat_str: TStringField
      FieldName = 'vat_str'
      Size = 40
    end
    object qNotavat_num: TFloatField
      FieldName = 'vat_num'
      Required = True
    end
    object qNotakd_del_place: TStringField
      FieldName = 'kd_del_place'
    end
    object qNotano_rekap: TStringField
      FieldName = 'no_rekap'
      Size = 128
    end
    object qNotan_hari: TIntegerField
      FieldName = 'n_hari'
      Required = True
    end
    object qNotaevocer: TFloatField
      FieldName = 'evocer'
      Required = True
    end
    object qNotano_faktur_pajak: TStringField
      FieldName = 'no_faktur_pajak'
      Size = 200
    end
    object qNotano_evocer: TStringField
      FieldName = 'no_evocer'
      Size = 200
    end
    object qNotaid_import: TLargeintField
      FieldName = 'id_import'
    end
    object qNotapromo_id: TStringField
      FieldName = 'promo_id'
      Size = 80
    end
    object qNotamvocer: TFloatField
      FieldName = 'mvocer'
      Required = True
    end
    object qNotano_mvocer: TStringField
      FieldName = 'no_mvocer'
      Size = 200
    end
    object qNotadisc_psn: TFloatField
      FieldName = 'disc_psn'
      Required = True
    end
    object qNotaisget: TStringField
      FieldName = 'isget'
      Required = True
      Size = 4
    end
    object qNotajns_transaksi: TStringField
      FieldName = 'jns_transaksi'
      Size = 400
    end
    object qNotadisc_total: TFloatField
      FieldName = 'disc_total'
      Required = True
    end
    object qNotadisc_member: TFloatField
      FieldName = 'disc_member'
      Required = True
    end
  ...
  object qTotal: TZQuery
    ...
    object qTotalvtotal: TFloatField
      FieldName = 'vtotal'
      ReadOnly = True
    end
  end
  ...
  object frxTT: TfrxReport
    ...
    object Page1: TfrxReportPage
      PaperWidth = 210.000000000000000000
      PaperHeight = 144.000000000000000000
      PaperSize = 256
      ...
      object MasterData1: TfrxMasterData
        ...
        Stretched = True
        object Memo30: TfrxMemoView
          Left = 581.724800000000000000
          Width = 136.385900000000000000
          Height = 15.118110240000000000
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[frxDBTotal."total_qris"]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          Left = 56.819110000000000000
          Width = 256.905690000000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object Memo17: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[frxDBTotal."total_debet"]')
          ParentFont = False
        end
      end
      object ColumnHeader1: TfrxColumnHeader
        FillType = ftBrush
        Height = 23.654642420000000000
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo2: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBTotal."kepala_kasir"]')
          ParentFont = False
        end
      end
      object ReportSummary1: TfrxReportSummary
        FillType = ftBrush
        Height = 21.296836900000000000
        Top = 332.598640000000000000
        Width = 718.110700000000000000
        object Memo6: TfrxMemoView
          Top = 6.178726659999995000
          Width = 309.792826670000000000
          Height = 15.118110240000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -12
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBTotal."total_qris">,MasterData1)]')
          ParentFont = False
        end
        object Memo24: TfrxMemoView
          Left = 314.000000000000000000
          Top = 6.209646669999983000
          Width = 133.719233330000000000
          Height = 15.118110240000000000
          DisplayFormat.FormatStr = '#,##;0,00'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBTotal."total_tunai">,MasterData1)]')
          ParentFont = False
        end
        object Memo25: TfrxMemoView
          Left = 448.000000000000000000
          ...
          HAlign = haRight
          Memo.UTF8 = (
            '[SUM(<frxDBTotal."total_debet">,MasterData1)]')
          ParentFont = False
        end
      end
    end
  end
  object qTotalUser: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select '
      
        '(case when c.vuser is null then '#39'Administrator'#39' else c.full_name' +
        ' end) as nama_kasir,'
      
        '(case when a.cara_bayar='#39'TUNAI'#39' then sum(a.total)end) as total_t' +
        'unai,'
      
        '(case when a.cara_bayar='#39'DEBET'#39' then sum(a.total)end) as total_d' +
        'ebet,'
      
        '(case when a.cara_bayar='#39'QRIS'#39' then sum(a.total)end) as total_qr' +
        'is,'
      'b.dt_transaksi, b.an as kepala_kasir, b.shift'
      'from accfin.kasir_detail a'
      'left join accfin.kasir b on b.id=a.id_kasir'
      'left join master.vuser c on c.vuser=a.nama_kasir'
      'where a.id_kasir=:id_kasir'
      
        'group by c.vuser, c.full_name, b.dt_transaksi, b.an, b.shift, a.' +
        'cara_bayar'
    ...
    object qTotalUsernama_kasir: TStringField
      FieldName = 'nama_kasir'
      Size = 120
    end
    object qTotalUserdt_transaksi: TDateTimeField
      FieldName = 'dt_transaksi'
    end
    object qTotalUserkepala_kasir: TStringField
      FieldName = 'kepala_kasir'
      Size = 400
    end
    object qTotalUsershift: TIntegerField
      FieldName = 'shift'
      Required = True
    end
    object qTotalUsertotal_tunai: TFloatField
      FieldName = 'total_tunai'
      ReadOnly = True
    end
    object qTotalUsertotal_debet: TFloatField
      FieldName = 'total_debet'
      ReadOnly = True
    end
    object qTotalUsertotal_qris: TFloatField
  ...
  object PopUp: TAdvPopupMenu
    ...
    Left = 659
    Top = 568
    object LaporanKasir1: TMenuItem
      Caption = 'Laporan Kasir'
      SubMenuImages = DM.ImageList1
      ImageIndex = 0
      OnClick = LaporanKasir1Click
    end
    object TSetoran1: TMenuItem
      Caption = 'TT Setoran'
      SubMenuImages = DM.ImageList1
      ImageIndex = 8
      OnClick = TSetoran1Click
    end
  end
end
