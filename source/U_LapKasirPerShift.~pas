...
uses
  ...
  dxSkinSummer2008, dxSkinValentine, dxSkinXmas2008Blue, cxDBLabel;
...
type
  ...
  TLapKasirPerShiftFrm = class(TForm)
    ...
    Detailispost_detail: TStringField;
    cxDBLabel1: TcxDBLabel;
    Label17: TLabel;
    Label7: TLabel;
    cxDBLabel2: TcxDBLabel;
    Mastertotal_unpost: TFloatField;
    Mastertotal_tunai: TFloatField;
    Mastertotal_debit: TFloatField;
    Mastertotal_qris: TFloatField;
    Label9: TLabel;
...
//    cxDBLabel4.Visible:= False;
//    cxDBLabel5.Visible:= False;
...
//    cxDBLabel2.Visible:= False;
    ...
    cxDBLabel3.Visible:= not isBrowse;
    cxDBLabel4.Visible:=  not isBrowse;
...
begin
   ...
   if (Master.State<>dsBrowse) then
    ...
    Try
      ...
      try
        ...
        if qNota.RecordCount>0 then begin
           ...
           while not qNota.Eof do begin
              ...
              if qNotaispost.AsString = '0' then begin
                 totunPost:= totunPost + qNotatotal.AsFloat;
      ...
      Master.Edit;
      Mastertotal_unpost.AsFloat:= totunPost;
      Mastertotal.AsFloat:= totPost;
