object MemorialUliFrm: TMemorialUliFrm
  Left = 277
  Top = 83
  Width = 964
  Height = 622
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini mewakili Jurnal Umum, digunakan untuk jurnal transaksi ' +
        'non kas/bank (reklas, penyusutan aset, dsb.) sebelum disimpan pa' +
        'stikan kondisi antara debet dan kredit sudah sesuai (balance)'
      Color = clWhite
      ...
      object grdMaster: TcxGrid
        ...
        object grddbtvMaster: TcxGridDBTableView
          ...
          object grddbtvMasterid_purchase_receive: TcxGridDBColumn
            Caption = 'Index #'
            DataBinding.FieldName = 'id_jurnal'
          ...
          object grddbtvMasterdt_req: TcxGridDBColumn
            Caption = 'Tanggal'
            DataBinding.FieldName = 'dt_jurnal'
            HeaderAlignmentHorz = taCenter
            Width = 66
          end
          ...
          object grddbtvMasterdebet: TcxGridDBColumn
            Caption = 'Nominal'
          ...
          object grddbtvMasterusr_post: TcxGridDBColumn
            Caption = 'User Posted'
            DataBinding.FieldName = 'usr_post'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 85
          end
          object grddbtvMasterdt_post: TcxGridDBColumn
            Caption = 'Tgl. Posted'
            DataBinding.FieldName = 'dt_post'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Editing = False
            Width = 73
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object edtKode: TcxDBTextEdit
          Left = 78
          Top = 39
          DataBinding.DataField = 'no_jurnal'
          DataBinding.DataSource = dsMaster
        ...
        object edtOrdering: TcxDBTextEdit
          Left = 78
          Top = 63
          DataBinding.DataField = 'id_jurnal'
          DataBinding.DataSource = dsMaster
          Properties.ReadOnly = True
        ...
        object edtDateEdit: TcxDBDateEdit
          Left = 78
          Top = 87
          DataBinding.DataField = 'dt_jurnal'
          DataBinding.DataSource = dsMaster
      ...
      object grdDetail: TcxGrid
        ...
        object grdDetailDBBTV: TcxGridDBTableView
          NavigatorButtons.ConfirmDelete = False
          ...
          DataController.Summary.FooterSummaryItems = <
            item
              ...
              Kind = skSum
              FieldName = 'debet'
              Column = grdDetailDBBTVdebet
            end
            item
              Format = '0.0,0'
              Kind = skSum
              FieldName = 'kredit'
              Column = grdDetailDBBTVkredit
            end>
          DataController.Summary.SummaryGroups = <>
          ...
          Styles.Header = cxStyle1
          Styles.Indicator = cxStyle4
          object grdDetailDBBTVnomor: TcxGridDBColumn
            Caption = 'NO.'
          ...
          object grdDetailDBBTVno_reff: TcxGridDBColumn
            Caption = 'NO. REFF.'
          ...
          object grdDetailDBBTVdescription: TcxGridDBColumn
            Caption = 'DISKRIPSI'
          ...
          object grdDetailDBBTVid_rek_gl: TcxGridDBColumn
            Caption = 'KODE REK'
          ...
          object grdDetailDBBTVnama_rekening: TcxGridDBColumn
          ...
          object grdDetailDBBTVdebet: TcxGridDBColumn
            Caption = 'DEBET'
            DataBinding.FieldName = 'debet'
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
          ...
          object grdDetailDBBTVkredit: TcxGridDBColumn
            Caption = 'KREDIT'
  ...
  object Master: TZQuery
    ...
    SQL.Strings = (
      'select * '
      'from accfin.jurnal'
      'where no_bukti='#39'ULI'#39' and id_jurnal=:id_jurnal')
    Params = <
      item
        DataType = ftUnknown
        Name = 'id_jurnal'
    ...
    object Masterid_jurnal: TLargeintField
      FieldName = 'id_jurnal'
      Required = True
    end
    object Masterno_jurnal: TStringField
      FieldName = 'no_jurnal'
      Size = 32
    end
    object Masterdt_jurnal: TDateTimeField
      FieldName = 'dt_jurnal'
      Required = True
    end
    ...
    object Masterremark: TStringField
      FieldName = 'remark'
      Size = 255
    end
    ...
    object Masterperuntukan: TStringField
    ...
    object Masterapproved_by_2: TStringField
      FieldName = 'approved_by_2'
      Size = 30
    end
    object Masterid_kurs: TStringField
      FieldName = 'id_kurs'
      Required = True
      Size = 3
    end
  ...
  object Detail: TZQuery
    ...
    object Detailid_jurnal: TLargeintField
      FieldName = 'id_jurnal'
    end
    object Detailid_jurnal_detail: TLargeintField
      FieldName = 'id_jurnal_detail'
    end
  ...
  object sq_Jurnal: TZSequence
    Connection = DM.conn
    SequenceName = 'accfin.sq_jurnal'
    Left = 508
    Top = 72
  end
  ...
  object qryGet_JU_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      'select accfin.fn_gen_memorial_number() as new_number')
    Params = <>
    Left = 509
    Top = 8
    object qryGet_JU_Numbernew_number: TStringField
      FieldName = 'new_number'
      ReadOnly = True
      Size = 255
    end
  end
  object qryDetailTotal: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select sum(debet) as total_debet, sum(kredit) as total_kredit'
      'from accfin.jurnal_detail'
      'where id_jurnal=:pid_jurnal')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid_jurnal'
    ...
    object qryDetailTotaltotal_debet: TFloatField
      FieldName = 'total_debet'
      ReadOnly = True
    end
    object qryDetailTotaltotal_kredit: TFloatField
      FieldName = 'total_kredit'
      ReadOnly = True
    end
  end
  object sq_Jurnal_detail: TZSequence
    Connection = DM.conn
    SequenceName = 'accfin.sq_jurnal_detail'
    Left = 536
    Top = 72
  end
  ...
  object MemMaster: TkbmMemTable
    ...
    object MemMasterno: TStringField
      FieldName = 'no'
    end
    ...
    object MemMasterdt: TStringField
      FieldName = 'dt'
    end
    object MemMasterdebet: TStringField
      FieldName = 'debet'
      Size = 100
    end
    object MemMasterkredit: TStringField
      FieldName = 'kredit'
      Size = 100
    end
  end
  object MemDetail: TkbmMemTable
    ...
    object MemDetaildebet: TStringField
      FieldName = 'debet'
    end
    object MemDetailkredit: TStringField
      FieldName = 'kredit'
    end
  end
  ...
  object L_Nota: TZReadOnlyQuery
    ...
    SQL.Strings = (
        ...
        'select a.no_nota, a.dt_nota, a.total, a.pembayaran, cast('#39'HUTANG' +
        #39' as character varying(10)) as jenis,  '
      
        #9'cast(Trim('#39'Faktu Pembelian No. '#39'||a.no_nota) as character varyi' +
        'ng(10)) as diskripsi, a.id_rek_gl'
      'from accfin.vlook_ap a'
      'where kd_rekanan=:pid_rekanan')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pid_rekanan'
    ...
    object L_Notajenis: TStringField
      FieldName = 'jenis'
      ReadOnly = True
      Size = 255
    end
    object L_Notadiskripsi: TStringField
      FieldName = 'diskripsi'
      ReadOnly = True
      Size = 10
    end
  ...
  object L_ID_REK_GL: TZReadOnlyQuery
    ...
    Left = 612
    Top = 13
    object L_ID_REK_GLvid_rek_gl: TStringField
      DisplayLabel = 'ID. Rek GL'
      DisplayWidth = 25
    ...
    object L_ID_REK_GLisdetail: TStringField
      DisplayLabel = 'Detail'
      DisplayWidth = 1
      FieldName = 'isdetail'
      Size = 1
  ...
  object EDT_REPO: TcxEditRepository
    Left = 765
    Top = 43
    object EDT_REPOLookKodeRekening: TcxEditRepositoryLookupComboBoxItem
      ...
      Properties.OnCloseUp = EDT_REPOLookKodeRekeningPropertiesCloseUp
      Properties.OnInitPopup = EDT_REPOLookKodeRekeningPropertiesInitPopup
    end
    object EDT_REPOTextItem1: TcxEditRepositoryTextItem
    end
    object EDT_REPOLookARUSKAS: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownAutoSize = True
      Properties.GridMode = True
    ...
    object EDT_REPOLookREKANAN: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownAutoSize = True
      Properties.GridMode = True
      Properties.KeyFieldNames = 'id_dokter'
      Properties.ListColumns = <
        item
          Caption = 'KODE'
          Width = 100
    ...
    object EDT_REPO_REFF: TcxEditRepositoryLookupComboBoxItem
      Properties.DropDownAutoSize = True
      Properties.GridMode = True
      ...
      Properties.PostPopupValueOnTab = True
      Properties.OnCloseUp = EDT_REPO_REFFPropertiesCloseUp
    end
  end
  ...
  object qBrowse: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT a.id_jurnal, a.no_jurnal, a.dt_jurnal, a.remark, a.usr_up' +
        'd, a.ispost, a.iscancel, a.debet, a.kd_rekanan, r.nama_rekanan, ' +
        'a.usr_post, a.dt_post'
      'FROM accfin.jurnal a'
      'LEFT JOIN master.mrekanan r ON r.kd_rekanan=a.kd_rekanan'
      
        'WHERE a.id_trans=:pid_trans and a.isdelete='#39'0'#39'  and a.no_bukti='#39 +
        'ULI'#39
      
        'AND a.dt_jurnal between to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') and to' +
    ...
    object qBrowseid_jurnal: TLargeintField
      FieldName = 'id_jurnal'
      Required = True
    end
    object qBrowseno_jurnal: TStringField
      FieldName = 'no_jurnal'
      Size = 32
    end
    object qBrowsedt_jurnal: TDateTimeField
      FieldName = 'dt_jurnal'
      Required = True
      DisplayFormat = 'dd-mmm-yyyy'
    end
    object qBrowseremark: TStringField
      FieldName = 'remark'
      Size = 255
    end
  ...
  object LNota: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      'select * from accfin.fn_get_jurnal_umum()'
      'where no_nota not in(select b.no_reff from accfin.jurnal a'
      #9#9'     join accfin.jurnal_detail b on b.id_jurnal=a.id_jurnal)'
      'order by dt_nota')
    Params = <>
    Left = 595
    Top = 75
    object LNotano_nota: TStringField
      FieldName = 'no_nota'
      ReadOnly = True
      Size = 255
    end
    object LNotadt_nota: TDateTimeField
      FieldName = 'dt_nota'
      ReadOnly = True
      DisplayFormat = 'dd/mm/yyyy'
    end
    object LNotaid_division: TStringField
      FieldName = 'id_division'
      ReadOnly = True
      Size = 255
    end
    object LNotakd_rekanan: TStringField
      FieldName = 'kd_rekanan'
      ReadOnly = True
      Size = 255
    end
    object LNotakd_item: TStringField
      FieldName = 'kd_item'
      ReadOnly = True
      Size = 255
    end
    object LNotanilai: TFloatField
      FieldName = 'nilai'
      ReadOnly = True
      DisplayFormat = '0.0,0'
    end
