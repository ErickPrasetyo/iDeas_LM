object SupplierFrm: TSupplierFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini berisi daftar supplier yang menjadi rekanan/supplier da' +
        'lam hal pengadaan material dan jasa'
      Color = clWhite
  ...
  object Master: TZQuery
    ...
    object Masteris_aktif: TStringField
      FieldName = 'is_aktif'
      Size = 4
    end
  end
