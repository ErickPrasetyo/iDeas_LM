object ImportHutangFrm: TImportHutangFrm
  Left = 202
  Top = 108
  Width = 951
  Height = 560
  ...
  object ADOConnection1: TADOConnection
    ConnectionString = 
      ...
      'wDeploy\iDeasULI\ExtractFaktur\AP\ap_ok.xls;Mode=ReadWrite;Persi' +
      'st Security Info=False;Jet OLEDB:System database="";Jet OLEDB:Re' +
      'gistry Path="";Jet OLEDB:Database Password="";Jet OLEDB:Engine T' +
      'ype=34;Jet OLEDB:Database Locking Mode=0;Jet OLEDB:Global Partia' +
  ...
  object oqAP: TZQuery
    ...
    object oqAPdt_faktur: TStringField
      FieldName = 'dt_faktur'
    end
    object oqAPdt_jth_tempo: TStringField
  ...
  object qryCekFaktur: TZQuery
    Connection = DM.conn
    SQL.Strings = (
      ' select transaksi.fn_cek_nota_hutang() as jumlah')
    Params = <>
    Left = 816
    Top = 64
    object qryCekFakturjumlah: TIntegerField
      FieldName = 'jumlah'
      ReadOnly = True
    end
  end
