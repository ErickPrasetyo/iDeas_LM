object InventoryAdjusmentFrm: TInventoryAdjusmentFrm
  ...
  object pnlHeader: TAdvPanel
    ...
    object lblHeader2: TLabel
      ...
      AutoSize = False
      Caption = 
        'Form ini berfungsi untuk mencocokan/mengoreksi data stok antara ' +
        'stok database dan stok opname'
      Color = clWhite
    ...
    object tsDetail: TcxTabSheet
      ...
      object pnlMaster: TSCPanel
        ...
        object RzGroupBox2: TRzGroupBox
          ...
          object edtCancel: TcxDBCheckBox
            Left = 102
            Top = 4
            Caption = 'Canceled'
      ...
      object grdDetail: TcxGrid
        ...
        object grddbtvDetail: TcxGridDBTableView
          ...
          object grddbtvDetailid_item: TcxGridDBColumn
            ...
            Properties.OnButtonClick = grddbtvDetailid_itemPropertiesButtonClick
            HeaderAlignmentHorz = taCenter
            HeaderAlignmentVert = vaCenter
            Options.Filtering = False
            Options.FilteringFilteredItemsList = False
  ...
  object aclFrm: TActionList
    ...
    object actLookItem: TAction
      ShortCut = 114
      OnExecute = actLookItemExecute
    end
  end
  ...
  object Master: TZQuery
    ...
    object Masterlreviewed_name: TStringField
      FieldKind = fkLookup
      FieldName = 'lreviewed_name'
    ...
    object Masterlapproved_name: TStringField
      FieldKind = fkLookup
      FieldName = 'lapproved_name'
      LookupDataSet = DM.L_User
      LookupKeyFields = 'vuser'
      LookupResultField = 'full_name'
  ...
  object sq_Mutasi: TZSequence
    Connection = DM.conn
    SequenceName = 'inventory.sq_mutasi'
    Left = 510
    Top = 10
  end
  object qryGet_Adjust_Number: TZQuery
    Connection = DM.conn
    SQL.Strings = (
    ...
    object qryGet_Adjust_Numbernew_number: TStringField
  ...
  object LItem: TZReadOnlyQuery
    ...
    SQL.Strings = (
      ...
      ''
      'from master.item c'
      'left join inventory.stock a on a.id_item=c.kd_item'
      'left join master.mcat_item d on d.id_cat_item=c.id_cat_item'
      ''
      'where c.isdetail='#39'1'#39
      
        'group by c.nama_item, c.kd_item, c.kd_satuan, a.id_warehouse, c.' +
        'id_cat_item, d.description'
      'order by (c.id_cat_item, c.nama_item)')
    Params = <>
    Left = 548
    Top = 11
    ...
    object LItemid_warehouse: TStringField
      DisplayLabel = 'LOKASI'
      DisplayWidth = 12
      FieldName = 'id_warehouse'
      Required = True
    ...
    object LItemdescription: TStringField
      DisplayWidth = 25
      FieldName = 'description'
      Visible = False
      Size = 400
  ...
  object MemDetail: TkbmMemTable
    ...
    object MemDetailwarehouse_id: TStringField
      FieldName = 'warehouse_id'
      Size = 10
    end
    object MemDetailwarehouse_id2: TStringField
      FieldName = 'warehouse_id2'
    end
    object MemDetailqty2: TFloatField
      FieldName = 'qty2'
    end
  end
  object MemMaster: TkbmMemTable
    ...
    object MemMastersupplier_name: TStringField
  ...
  object cxEditRepository1: TcxEditRepository
    ...
    object ER_LCB_GUDANG: TcxEditRepositoryLookupComboBoxItem
  ...
  object qryGetStok: TZReadOnlyQuery
    Connection = DM.conn
    SQL.Strings = (
      
        'select coalesce(sum(coalesce(a.qty_in,0)-coalesce(a.qty_ot,0)),0' +
        ') as stok'
      ''
      ...
      'a.id_item=:pid_item '
        ...
        'and a.dt_doc<=to_timestamp(:ptgl0,'#39'dd/mm/yyyy'#39') +  interval '#39'23 ' +
        'hours 59 min'#39
      '')
    Params = <
      item
    ...
    object qryGetStokstok: TFloatField
      FieldName = 'stok'
      ReadOnly = True
    end
  end
  object LookItem: TwwLookupDialog
    Selected.Strings = (
      'item_name'#9'50'#9'Nama Item'#9'F'
      'id_item'#9'30'#9'Kode Item'#9'F'
      'satuan'#9'20'#9'Satuan'#9'F'
      'stok_akhir'#9'20'#9'Stok'#9'F')
    GridTitleAlignment = taCenter
    GridColor = clWhite
    GridOptions = [dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    LookupTable = Item
    ...
    object Page1: TfrxReportPage
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo15: TfrxMemoView
          ...
          Height = 18.897650000000000000
          DataField = 'documen_distribution'
          DataSet = frxDBMaster
          DataSetName = 'frxDBMaster'
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBMaster."documen_distribution"]')
          ParentFont = False
        end
      end
      object HeaderPRDetail: TfrxHeader
  ...
  object sq_mutasi_detail: TZSequence
    Connection = DM.conn
  ...
  object ADODataSet1: TADODataSet
    ...
    object ADODataSet1F6: TStringField
      FieldName = 'F6'
    end
  end
  ...
  object Item: TZReadOnlyQuery
    ...
    SQL.Strings = (
      'select *'
      'from inventory.fn_get_stok_warehouse(:pgudang,:ptgl0,:ptgl0)')
    Params = <
      item
        DataType = ftUnknown
        Name = 'pgudang'
    ...
    object Itemid_item: TStringField
    ...
    object Itemstok_akhir: TFloatField
      DisplayLabel = 'Stok'
      DisplayWidth = 20
      FieldName = 'stok_akhir'
      ReadOnly = True
    end
    object Itemid_cat_item: TStringField
      FieldName = 'id_cat_item'
      ReadOnly = True
      Visible = False
      Size = 252
    end
    object Itemlok_rak: TStringField
      FieldName = 'lok_rak'
      ReadOnly = True
      Visible = False
      Size = 252
    end
    object Itemid_parent: TStringField
      FieldName = 'id_parent'
      ReadOnly = True
      Visible = False
      Size = 252
    end
    object Itemparent_name: TStringField
      FieldName = 'parent_name'
      ReadOnly = True
      Visible = False
      Size = 252
    end
    object Itemstok_awal: TFloatField
      FieldName = 'stok_awal'
      ReadOnly = True
      Visible = False
    end
    object Itemtotal_in: TFloatField
      FieldName = 'total_in'
      ReadOnly = True
      Visible = False
    end
    object Itemtotal_ot: TFloatField
      FieldName = 'total_ot'
      ReadOnly = True
      Visible = False
    end
