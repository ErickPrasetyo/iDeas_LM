object RepairItemFrm: TRepairItemFrm
  Left = 301
  Top = 228
  Width = 584
  Height = 233
  BorderStyle = bsSizeToolWin
  Caption = 'Perbaikan Data Master Item/PC-Code'
  Color = clWindow
  Ctl3D = False
  ...
  object oqITEM: TZQuery
    ...
    object oqITEMid_cat_item: TStringField
      FieldName = 'id_cat_item'
      Size = 1020
    end
  end
  object sdfdtstItem: TSdfDataSet
    FileMustExist = True
    ReadOnly = False
    FileName = 
      'C:\Users\ERICK\Desktop\ACP Data Export\Daftar Master Produk M2 P' +
      'MK.txt'
    Schema.Strings = (
      'Field1'
      'Field2'
