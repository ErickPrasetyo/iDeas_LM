object LookRekeningRLFrm: TLookRekeningRLFrm
  Left = 235
  Top = 209
  Width = 695
  Height = 374
  ...
  object LPR_Item_Status: TZQuery
    ...
    SQL.Strings = (
        ...
        'select CAST('#39'0'#39' AS character varying(1)) as selected, a.id_rek_g' +
        'l, a.descriptions, a.golongan, a.id_rek_rl,  b.diskripsi as nama' +
        '_rekening'
      'from master.mrek_gl a'
      'left join accfin.mrek_laba_rugi b on b.id_rek_rl=a.id_rek_rl'
      'where a.isdetail='#39'1'#39' AND a.golongan='#39'RL'#39
  ...
  object kmtPR: TkbmMemTable
    ...
    object kmtPRid_rek_rl: TStringField
      FieldName = 'id_rek_rl'
    end
